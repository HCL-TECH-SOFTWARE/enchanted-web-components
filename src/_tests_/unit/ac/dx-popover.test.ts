...
describe("dx-popover - component test", () => {
  it("dx-popover - should render popover with label and text", async () => {
    ...
    `);
    expect(await $("dx-popover")).toBeExisting();
    const popover = await $("dx-popover");
    expect(await popover.getAttribute("label")).toBe("Label");
    expect(await popover.getAttribute("text")).toBe("Text");
  });

  it('dx-popover - should hide label, text and closeIcon when showLabel, showText and showCloseIcon are false ', async () => {
    renderComponent (html`
      <dx-popover
        label="Label"
        text="Text"
  ...
  it('dx-popover - should show label and text when showLabel and showText are true ', async () => {
    renderComponent (html`
      <dx-popover
        label="Label"
        text="Text"
  ...
  it('dx-popover - should render only label when showLabel is true and showText is false ', async () => {
    renderComponent (html`
      <dx-popover
        label="Label"
        text="Text"
  ...
  it('dx-popover - should not show arrow when arrow attribute is set to ""  ', async () => {
    renderComponent (html`
      <dx-popover
        label="Label"
        text="Text"
  ...
  it('dx-popover - should open popover without arrow when arrow attribute is not set ', async () => {
    renderComponent (html`
      <dx-popover
        label="Label"
        text="Text"
  ...
  it('dx-popover - should close popover on close icon click ', async () => {
    renderComponent (html`
      <dx-popover
        label="Label"
        text="Text"
  ...
  it('dx-popover - should apply correct theme when  theme ="dark" attribute', async () => {
    renderComponent (html`
      <dx-popover
        label="Label"
        text="Text"
  ...
  it('dx-popover - should show arrow in correct position based on arrow attribute', async () => {
    renderComponent (html`
      <dx-popover
        label="Label"
        text="Text"
    ...
    `);
    const popover = await $("dx-popover");
    expect(await popover.getAttribute("arrow")).toBe(DxPopoverArrowPosition.BOTTOM_LEFT);
  });

  it('dx-popover - should only show popover for element with slot="target" in parent div', async () => {
    renderComponent (html`
      <div id="parent-div">
        <dx-popover
          label="Label"
