import{c as C,$ as v,a as y,L as f,u as l,g as N,n as i,a0 as t,f as e}from"./tags-BoxFtPAv.js";import{E as h}from"./iframe-CXiC-zJe.js";import"./index-CZiPudfq.js";import{g as D}from"./localization-YUdjb7F_.js";import{q as a,r as w}from"./cssClassEnums-CY7zIYSt.js";import"./enchanted-button-ClBT8-Pl.js";var H=Object.defineProperty,s=(n,d,E,B)=>{for(var p=void 0,u=n.length-1,c;u>=0;u--)(c=n[u])&&(p=c(d,E,p)||p);return p&&H(d,E,p),p};const L=C("enchanted-web-components:components:atomic-component:enchanted-popover.ts");class r extends y{constructor(){super(...arguments),this.open=!1,this.label="Label",this.text="Text",this.showLabel=!1,this.showText=!1,this.showCloseIcon=!1,this.inverse=!1,this.withpadding=!1,this.disablePopover=!1,this._showPopover=()=>{this.disablePopover||(this.open=!0)},this._onFocusIn=()=>{this.disablePopover||(this.open=!0)},this._onFocusOut=()=>{this.disablePopover||(this.open=!1)},this._hidePopover=()=>{this.disablePopover||(this.open=!1)},this._onCloseClick=d=>{d.stopPropagation(),this.open=!1,this.dispatchEvent(new CustomEvent("enchanted-popover-closed",{bubbles:!0,composed:!0,detail:{reason:"click-icon-close"}}))}}get isLTR(){return D()===f.LTR}render(){return l`
    ...
    <div part="${a.POPOVER_WRAPPER}" ?inverse=${this.inverse} aria-label=${this.label}>
      ${this.arrow?l`
      <div part="${a.POPOVER_ARROW}"></div>`:h}
        <div part=${this.isLTR?a.POPOVER_CONTAINER:a.POPOVER_CONTAINER_RTL}>
          <div part="${a.POPOVER_CONTENT}">
            ${this.showLabel?l`<div part="${a.POPOVER_LABEL}"><slot name="${w.LABEL}">${this.label}</slot></div>`:h}
            ${this.showText?l`<div part="${a.POPOVER_TEXT}"><slot name="${w.TEXT}">${this.text}</slot></div>`:h}
    ...
    <${t}
      ...
      ?disablePopover=${n.disablePopover}
  ...
  `};var O,b,_;$.parameters={...$.parameters,docs:{...(O=$.parameters)==null?void 0:O.docs,source:{originalSource:`{
  name: 'Default',
  render: args => {
    return html\`
...
}`,...(_=(b=$.parameters)==null?void 0:b.docs)==null?void 0:_.source}}};var A,g,P,m,x;T.parameters={...T.parameters,docs:{...(A=T.parameters)==null?void 0:A.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    }
...
}`,...(P=(g=T.parameters)==null?void 0:g.docs)==null?void 0:P.source},description:{story:`Comprehensive showcase of all popover states and arrow positions.
...
- Label and text visibility combinations`,...(x=(m=T.parameters)==null?void 0:m.docs)==null?void 0:x.description}}};const R=["EnchantedPopoverStory","AllStates"],M=Object.freeze(Object.defineProperty({__proto__:null,AllStates:T,EnchantedPopoverStory:$,__namedExportsOrder:R,default:G},Symbol.toStringTag,{value:"Module"}));export{M as E,$ as a};
