import{c as x,a6 as v,E as C,L as y,u as l,g as c,n as i,a7 as t,s as e}from"./tags-DNFXWRh_.js";import{E as d}from"./iframe-DhKPB2Pq.js";import"./index-CXcGPBSU.js";import{g as D}from"./localization-Kyreav0j.js";import{t as a}from"./cssClassEnums-mKa0OyBd.js";import"./enchanted-button-DcfpPyjl.js";import"./preload-helper-C1FmrZbK.js";import"./index-CuTRIAwF.js";import"./tags-DtitqHDF.js";import"./state-DqCe3E1z.js";import"./keyboardEventKeys-BnoN8uA3.js";var f=Object.defineProperty,s=(n,$,w,G)=>{for(var p=void 0,u=n.length-1,E;u>=0;u--)(E=n[u])&&(p=E($,w,p)||p);return p&&f($,w,p),p};const H=x("enchanted-web-components:components:atomic-component:enchanted-popover.ts");class r extends C{constructor(){super(...arguments),this.open=!1,this.label="Label",this.text="Text",this.showLabel=!1,this.showText=!1,this.showCloseIcon=!1,this.inverse=!1,this.withpadding=!1,this.disablePopover=!1,this._showPopover=()=>{this.disablePopover||(this.open=!0)},this._onFocusIn=()=>{this.disablePopover||(this.open=!0)},this._onFocusOut=()=>{this.disablePopover||(this.open=!1)},this._hidePopover=()=>{this.disablePopover||(this.open=!1)},this._onCloseClick=$=>{$.stopPropagation(),this.open=!1,this.dispatchEvent(new CustomEvent("enchanted-popover-closed",{bubbles:!0,composed:!0,detail:{reason:"click-icon-close"}}))}}get isLTR(){return D()===y.LTR}render(){return l`
...
}`,...(b=(O=h.parameters)==null?void 0:O.docs)==null?void 0:b.source}}};var _,A,g,m,P;T.parameters={...T.parameters,docs:{...(_=T.parameters)==null?void 0:_.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    }
...
- Label and text visibility combinations`,...(P=(m=T.parameters)==null?void 0:m.docs)==null?void 0:P.description}}};const j=["EnchantedPopoverStory","AllStates"];export{T as AllStates,h as EnchantedPopoverStory,j as __namedExportsOrder,z as default};
