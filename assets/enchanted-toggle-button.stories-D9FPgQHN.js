import{c as U,an as B,E as A,u as r,z as h,k as E,n as o,ao as n}from"./tags-DNFXWRh_.js";import{E as u,x as L}from"./iframe-DhKPB2Pq.js";import{i as w}from"./localization-Kyreav0j.js";import"./enchanted-badge-BRbvz0vR.js";import"./enchanted-icon-button-Dgo7vSho.js";import{K as t,I as V}from"./cssClassEnums-mKa0OyBd.js";import{I as D}from"./exportParts-cEl5bd2S.js";import"./preload-helper-C1FmrZbK.js";import"./enchanted-button-DcfpPyjl.js";import"./state-DqCe3E1z.js";import"./keyboardEventKeys-BnoN8uA3.js";var y=Object.defineProperty,s=(a,i,e,v)=>{for(var d=void 0,f=a.length-1,_;f>=0;f--)(_=a[f])&&(d=_(i,e,d)||d);return d&&y(i,e,d),d};const S=U("enchanted-web-components:components:atomic-component:enchanted-toggle-button.ts");class l extends A{constructor(){super(...arguments),this.singleButton=!1,this.toggleOn=!1,this.showBadge=!1,this.disabled=!1,this.outlined=!1,this.selectedValue="",this.iconUrls=[],this.icons=[],this.values=[],this.singleButtonTitle="",this.singleButtonAria=""}handleClick(i){i.stopPropagation();const e=i.currentTarget;if(e.value!==this.selectedValue){const v=new CustomEvent("click",{detail:{value:e.value}});this.dispatchEvent(v)}}partAttributeDecider(i){let e=i;switch(i){case t.TOGGLE_BUTTON_DIV:return this.outlined&&(e=t.TOGGLE_BUTTON_DIV_OUTLINED),e;case t.FIRST_BUTTON:return this.selectedValue===this.values[0]?e=t.TOGGLE_BUTTON_SELECTED:e=t.TOGGLE_BUTTON,e;case t.SECOND_BUTTON:return this.selectedValue===this.values[1]?e=t.TOGGLE_BUTTON_SELECTED:e=t.TOGGLE_BUTTON,e;case t.TOGGLE_BUTTON_ICON:return e;default:return e}}getButtonAttribute(){return this.toggleOn?t.TOGGLE_ON_SINGLE_BUTTON:t.TOGGLE_OFF_SINGLE_BUTTON}renderIcon(i,e){return i?typeof i=="string"?r`
        <img
          src="${i}"
          alt="${i}"
