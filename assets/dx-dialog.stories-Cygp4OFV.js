import{E as h,x as p}from"./iframe-Dsd1MpWQ.js";import{n as u,D,t as w,l as _}from"./dx-ac-base-element-C9dhstFR.js";import{l as f}from"./lodash-BXdGFY-L.js";import"./dx-svg-icon-9LpOfG7A.js";import"./dx-button-gwJQrlvi.js";import{l as t}from"./cssClassEnums-v1h5zF5X.js";import{i as b}from"./localization-DmqTGOFp.js";import{K as x}from"./keyboardEventKeys-BnoN8uA3.js";import"./index-DBmzuMS8.js";import"./preload-helper-C1FmrZbK.js";import"./state-DQlunuPl.js";import"./index-BPZZDKKN.js";var e=(i=>(i.XL="xl",i.LG="lg",i.MD="md",i.SM="sm",i.XS="xs",i.CHAT="chat",i))(e||{}),A=Object.defineProperty,L=Object.getOwnPropertyDescriptor,c=(i,o,s,n)=>{for(var l=n>1?void 0:n?L(o,s):o,d=i.length-1,a;d>=0;d--)(a=i[d])&&(l=(n?a(o,s,l):a(l))||l);return n&&l&&A(o,s,l),l};let r=class extends D{constructor(){super(...arguments),this.open=!1,this.size=e.XL,this.dialogTitle="",this.overrideTitle=!1,this.removeBorder=!1}connectedCallback(){super.connectedCallback(),this.dialogTitle===""&&(this.dialogTitle=this.getMessage("generic.label"))}disconnectedCallback(){super.disconnectedCallback()}async updated(o){o.has("open")&&this.open&&(await this.updateComplete,this._focusFirstElement())}_focusFirstElement(){const o=this.renderRoot.querySelectorAll("slot");for(const l of Array.from(o)){const d=l.assignedElements({flatten:!0});for(const a of d){if(a.matches(r.FOCUSABLE_SELECTOR)){this._focusElement(a);return}const v=a.querySelector(r.FOCUSABLE_SELECTOR);if(v){this._focusElement(v);return}}}const s=this.renderRoot.querySelector(r.FOCUSABLE_SELECTOR);if(s){this._focusElement(s);return}const n=this.renderRoot.querySelector(`[part*="${this.getPaperPart()}"]`);n==null||n.focus()}_hasShadowRoot(o){return"shadowRoot"in o&&o.shadowRoot instanceof ShadowRoot}_hasRenderRoot(o){return"renderRoot"in o&&o.renderRoot instanceof ShadowRoot}_focusElement(o,s=0){if(s>=r.MAX_FOCUS_DEPTH){o.focus();return}let n=o,l=null,d=s;for(;n&&d<r.MAX_FOCUS_DEPTH;){if(this._hasShadowRoot(n)){const a=n.shadowRoot.querySelector(r.FOCUSABLE_SELECTOR);if(a){n=a,l=a,d++;continue}}else if(this._hasRenderRoot(n)){const a=n.renderRoot.querySelector(r.FOCUSABLE_SELECTOR);if(a){n=a,l=a,d++;continue}}break}(l||o).focus()}async refocusDialog(){this.open&&(await this.updateComplete,this._focusFirstElement())}handleClose(o){o.stopPropagation(),this.open=!1,this.dispatchEvent(new CustomEvent("dx-dialog-close",{bubbles:!0,composed:!0}))}handleCloseByEnterKey(o){(o.key===x.ENTER||o.key===x.SPACE)&&(o.stopPropagation(),this.handleClose(o))}getContainerPart(){switch(this.size){case e.XL:return t.CONTAINER_XL;case e.XS:return t.CONTAINER_XS;case e.SM:return t.CONTAINER_SM;case e.MD:return t.CONTAINER_MD;case e.LG:return t.CONTAINER_LG;case e.CHAT:return t.CONTAINER_CHAT;default:return t.CONTAINER_XL}}getPaperPart(){switch(this.size){case e.XL:return t.PAPER_XL;case e.XS:return t.PAPER_XS;case e.SM:return t.PAPER_SM;case e.MD:return t.PAPER_MD;case e.LG:return t.PAPER_LG;case e.CHAT:return t.PAPER_CHAT;default:return t.PAPER_XL}}getContentPart(){switch(this.size){case e.XL:return this.removeBorder?t.CONTENT_XL_NO_BORDER:t.CONTENT_XL;case e.XS:return t.CONTENT_XS;case e.SM:return t.CONTENT_SM;case e.MD:return t.CONTENT_MD;case e.LG:return t.CONTENT_LG;case e.CHAT:return t.CONTENT_CHAT;default:return t.CONTENT_XL}}getPaginationPart(){switch(this.size){case e.XS:return t.PAGINATION_XS;case e.SM:return t.PAGINATION_SM;case e.MD:return t.PAGINATION_MD;case e.LG:return t.PAGINATION_LG;case e.XL:default:return t.PAGINATION_XL}}getActionPart(){return this.removeBorder?t.ACTION_NO_BORDER:this.size===e.CHAT?t.CHAT_ACTION:t.ACTION}render(){const o=this.size===e.CHAT;return this.open?p`
        <div role="presentation" part=${o?t.DIALOG_ROOT_CHAT:t.DIALOG_ROOT}>
          ${o?h:p`<div aria-hidden="true" part=${t.BACKDROP} @click=${f.debounce(this.handleClose,300)}></div>`}
      ...
      <div style="display: flex; flex-direction: column; gap: 40px; padding: 20px;">
        <div>
          ...
          <div style="display: flex; flex-direction: column; gap: 20px;">
            <dx-dialog .dialogTitle=${"Extra Large Dialog (XL)"} .size=${e.XL} ?open=${!0}>
              <div slot="content">
            ...
            <dx-dialog .dialogTitle=${"Large Dialog (LG)"} .size=${e.LG} ?open=${!0}>
              <div slot="content">
            ...
            <dx-dialog .dialogTitle=${"Medium Dialog (MD)"} .size=${e.MD} ?open=${!0}>
              <div slot="content">
            ...
            <dx-dialog .dialogTitle=${"Small Dialog (SM)"} .size=${e.SM} ?open=${!0}>
              <div slot="content">
            ...
            <dx-dialog .dialogTitle=${"Extra Small Dialog (XS)"} .size=${e.XS} ?open=${!0}>
              <div slot="content">
        ...
        <div style="margin-top: 40px;">
          ...
          <div style="display: flex; flex-direction: column; gap: 20px;">
            <dx-dialog .dialogTitle=${"Dialog with Custom Title Slot"} .size=${e.MD} ?open=${!0} ?overrideTitle=${!0}>
            ...
            <dx-dialog .dialogTitle=${"Dialog without Border"} .size=${e.MD} ?open=${!0} ?removeBorder=${!0}>
              <div slot="content">
            ...
            <dx-dialog .dialogTitle=${"Dialog with Rich Content"} .size=${e.LG} ?open=${!0}>
              <div slot="content">
            ...
            <dx-dialog .dialogTitle=${"Confirmation Dialog"} .size=${e.SM} ?open=${!0}>
              <div slot="content">
  ...
  name: 'Default'
}`,...(C=(T=g.parameters)==null?void 0:T.docs)==null?void 0:C.source}}};var S,E,$;m.parameters={...m.parameters,docs:{...(S=m.parameters)==null?void 0:S.docs,source:{originalSource:`{
  render: () => {
    return html\`
      <div style="display: flex; flex-direction: column; gap: 40px; padding: 20px;">
        <div>
          ...
          <p style="margin: 10px 0; color: #666;">All dialogs shown with open=true for visualization. In production, only one dialog would be open at a time.</p>
          <div style="display: flex; flex-direction: column; gap: 20px;">
            <dx-dialog .dialogTitle=\${'Extra Large Dialog (XL)'} .size=\${DialogSizes.XL} ?open=\${true}>
              <div slot="content">
                <p>This is an extra large (XL) dialog. It provides the most space for content and is suitable for complex forms or detailed information displays.</p>
                <p>Content can include multiple paragraphs, forms, tables, or any other HTML elements.</p>
              </div>
            ...
            <dx-dialog .dialogTitle=\${'Large Dialog (LG)'} .size=\${DialogSizes.LG} ?open=\${true}>
              <div slot="content">
                <p>This is a large (LG) dialog. It provides ample space for most use cases including forms with multiple fields.</p>
              </div>
              <div slot="footer">
            ...
            <dx-dialog .dialogTitle=\${'Medium Dialog (MD)'} .size=\${DialogSizes.MD} ?open=\${true}>
              <div slot="content">
                <p>This is a medium (MD) dialog. A balanced size suitable for most standard dialogs with moderate content.</p>
              </div>
              <div slot="footer">
            ...
            <dx-dialog .dialogTitle=\${'Small Dialog (SM)'} .size=\${DialogSizes.SM} ?open=\${true}>
              <div slot="content">
                <p>This is a small (SM) dialog. Compact size for simple messages or quick confirmations.</p>
              </div>
              <div slot="footer">
            ...
            <dx-dialog .dialogTitle=\${'Extra Small Dialog (XS)'} .size=\${DialogSizes.XS} ?open=\${true}>
              <div slot="content">
                <p>Extra small (XS) dialog for minimal content or quick alerts.</p>
              </div>
              <div slot="footer">
        ...
        <div style="margin-top: 40px;">
          <h3 style="margin-top: 0;">Dialog Variations</h3>
          <div style="display: flex; flex-direction: column; gap: 20px;">
            <dx-dialog .dialogTitle=\${'Dialog with Custom Title Slot'} .size=\${DialogSizes.MD} ?open=\${true} ?overrideTitle=\${true}>
              <span slot="title" style="display: flex; align-items: center; gap: 8px; color: #1976d2;">
                <span>🔔</span>
                <strong>Custom Styled Title with Icon</strong>
              </span>
            ...
            <dx-dialog .dialogTitle=\${'Dialog without Border'} .size=\${DialogSizes.MD} ?open=\${true} ?removeBorder=\${true}>
              <div slot="content">
                <p>This dialog has removeBorder set to true, removing the border styling from the dialog container.</p>
                <p>Useful for custom styling or seamless integration with specific design requirements.</p>
              </div>
            ...
            <dx-dialog .dialogTitle=\${'Dialog with Rich Content'} .size=\${DialogSizes.LG} ?open=\${true}>
              <div slot="content">
                <h4 style="margin-top: 0;">Form Example</h4>
                <div style="display: flex; flex-direction: column; gap: 12px;">
                  <div>
            ...
            <dx-dialog .dialogTitle=\${'Confirmation Dialog'} .size=\${DialogSizes.SM} ?open=\${true}>
              <div slot="content">
                <p style="margin: 0;">Are you sure you want to delete this item? This action cannot be undone.</p>
              </div>
              <div slot="footer" style="display: flex; gap: 8px; justify-content: flex-end;">
...
}`,...($=(E=m.parameters)==null?void 0:E.docs)==null?void 0:$.source}}};const q=["DxDialog","AllStates"];export{m as AllStates,g as DxDialog,q as __namedExportsOrder,U as default};
