import{c as h,F as v,a as S,g as s,u as i,n as R,y as C,G as t}from"./tags-BB5KXmdF.js";import{E as u}from"./iframe-B4blCNHZ.js";import{a0 as e,a1 as r,b as n}from"./cssClassEnums-CY7zIYSt.js";import"./index-Bnvg8u64.js";import"./index-Bd8nQgHY.js";var O=Object.defineProperty,D=Object.getOwnPropertyDescriptor,A=(a,_,c,N)=>{for(var T=N>1?void 0:N?D(_,c):_,d=a.length-1,L;d>=0;d--)(L=a[d])&&(T=(N?L(_,c,T):L(T))||T);return N&&T&&O(_,c,T),T};const f=h("enchanted-web-components:components:atomic-component:enchanted-alert.ts");let E=class extends S{constructor(){super(...arguments),this.message="",this.width=240,this.variant="contained",this.severity="info"}getAlertPart(){switch(this.severity){case e.ALERT_INFO:return this.variant===r.ALERT_CONTAINED?n.ALERT_CONTAINED_INFO:n.ALERT_OUTLINED_INFO;case e.ALERT_ERROR:return this.variant===r.ALERT_CONTAINED?n.ALERT_CONTAINED_ERROR:n.ALERT_OUTLINED_ERROR;case e.ALERT_WARNING:return this.variant===r.ALERT_CONTAINED?n.ALERT_CONTAINED_WARNING:n.ALERT_OUTLINED_WARNING;case e.ALERT_SUCCESS:return this.variant===r.ALERT_CONTAINED?n.ALERT_CONTAINED_SUCCESS:n.ALERT_OUTLINED_SUCCESS;default:return""}}getAlertIcon(){switch(this.severity){case e.ALERT_INFO:return i`<${s("icon-information")} size="16" part="${this.getAlertSVG()}"></${s("icon-information")}>`;case e.ALERT_ERROR:return i`<${s("icon-warning")} size="16" part="${this.getAlertSVG()}"></${s("icon-warning")}>`;case e.ALERT_WARNING:return i`<${s("icon-warning-alt")} size="16" part="${this.getAlertSVG()}"></${s("icon-warning-alt")}>`;case e.ALERT_SUCCESS:return i`<${s("icon-checkmark-outline")} size="16" part="${this.getAlertSVG()}"></${s("icon-checkmark-outline")}>`;default:return u}}getAlertSVG(){switch(this.severity){case e.ALERT_INFO:return n.ALERT_SVG_INFO;case e.ALERT_ERROR:return n.ALERT_SVG_ERROR;case e.ALERT_WARNING:return n.ALERT_SVG_WARNING;case e.ALERT_SUCCESS:return n.ALERT_SVG_SUCCESS;default:return""}}render(){return i`
      <div part="${n.ALERT_DIV_ROOT} ${this.getAlertPart()}" style="width:${this.width}px">
          ${this.getAlertIcon()}
          <div part="${n.ALERT_CONTENT}">
            ${this.alertTitle?i`<div part="${n.ALERT_TITLE}">${this.alertTitle}</div>`:u}
            <span>${this.message}</span>
          </div>
      </div>`}};A([R({type:String})],E.prototype,"message",2);A([R({type:String})],E.prototype,"alertTitle",2);A([R({type:Number})],E.prototype,"width",2);A([R({type:String})],E.prototype,"variant",2);A([R({type:String})],E.prototype,"severity",2);E=A([C()],E);customElements.get(v)?f("Component (%s) is currently registered and not possible to registrate again.",v):customElements.define(v,E);const G={title:"Feedback/Enchanted Alert",component:"enchanted-alert",tags:["a11y-addon"],argTypes:{severity:{control:{type:"radio"},options:[e.ALERT_INFO,e.ALERT_SUCCESS,e.ALERT_WARNING,e.ALERT_ERROR],description:"Defines the severity level of the alert (info, success, warning, error)",table:{type:{summary:"string"},defaultValue:{summary:e.ALERT_INFO}}},variant:{control:{type:"radio"},options:[r.ALERT_CONTAINED,r.ALERT_OUTLINED],description:"Defines the visual style variant (contained with background, or outlined)",table:{type:{summary:"string"},defaultValue:{summary:r.ALERT_CONTAINED}}},message:{control:{type:"text"},description:"The message text to display in the alert",table:{type:{summary:"string"},defaultValue:{summary:""}}},alertTitle:{control:{type:"text"},description:"Optional title text to display above the message",table:{type:{summary:"string | undefined"},defaultValue:{summary:"undefined"}}},width:{control:{type:"number",min:100,max:1e3,step:10},description:"Width of the alert in pixels",table:{type:{summary:"number"},defaultValue:{summary:"240"}}}},args:{severity:e.ALERT_INFO,variant:r.ALERT_CONTAINED,message:"This is a enchanted-alert!",width:240},parameters:{docs:{description:{component:"Alert component for displaying important messages to users with various severity levels. Supports two visual variants (contained and outlined) and four severity types (info, success, warning, error). Each severity level has a corresponding icon and color scheme."}}}},o={render:a=>i`
      <${t}
        .message=${a.message} 
        .severity=${a.severity} 
        .variant=${a.variant}
      ...
      ></${t}>
    `,name:"Default",parameters:{docs:{description:{story:"Default alert with customizable severity, variant, message, and width. Try different severity levels to see the color schemes and icons change."}}}},l={render:()=>i`
  ...
  `,parameters:{docs:{description:{story:"Showcase of all severity levels (info, success, warning, error) in both contained and outlined variants. This demonstrates the complete range of alert styles available."}}}};var $,m,g;o.parameters={...o.parameters,docs:{...($=o.parameters)==null?void 0:$.docs,source:{originalSource:`{
  render: args => {
    return html\`
      <\${ENCHANTED_ALERT_TAG}
...
}`,...(g=(m=o.parameters)==null?void 0:m.docs)==null?void 0:g.source}}};var p,y,I;l.parameters={...l.parameters,docs:{...(p=l.parameters)==null?void 0:p.docs,source:{originalSource:`{
  render: () => {
    return html\`
    <div style="display: flex; flex-direction: column; gap: 16px;">
      <div><strong>Contained Variant</strong></div>
...
}`,...(I=(y=l.parameters)==null?void 0:y.docs)==null?void 0:I.source}}};const w=["EnchantedAlert","AllStates"],F=Object.freeze(Object.defineProperty({__proto__:null,AllStates:l,EnchantedAlert:o,__namedExportsOrder:w,default:G},Symbol.toStringTag,{value:"Module"}));export{F as E,o as a};
