        ...
        <div>
          ...
          <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 40px; place-items: center;">
            <div style="text-align: center;">
              ...
              <${t} tooltiptext="Top placement" placement="${n.TOOLTIP_TOP}" show>
            ...
            <div style="text-align: center;">
              ...
              <${t} tooltiptext="Top start placement" placement="${n.TOOLTIP_TOP_START}" show>
            ...
            <div style="text-align: center;">
              ...
              <${t} tooltiptext="Top end placement" placement="${n.TOOLTIP_TOP_END}" show>
            ...
            <div style="text-align: center;">
              ...
              <${t} tooltiptext="Bottom placement" placement="${n.TOOLTIP_BOTTOM}" show>
            ...
            <div style="text-align: center;">
              ...
              <${t} tooltiptext="Bottom start placement" placement="${n.TOOLTIP_BOTTOM_START}" show>
            ...
            <div style="text-align: center;">
              ...
              <${t} tooltiptext="Bottom end placement" placement="${n.TOOLTIP_BOTTOM_END}" show>
            ...
            <div style="text-align: center;">
              ...
              <${t} tooltiptext="Left placement" placement="${n.TOOLTIP_LEFT}" show>
            ...
            <div style="text-align: center;">
              ...
              <${t} tooltiptext="Left start placement" placement="${n.TOOLTIP_LEFT_START}" show>
            ...
            <div style="text-align: center;">
              ...
              <${t} tooltiptext="Left end placement" placement="${n.TOOLTIP_LEFT_END}" show>
            ...
            <div style="text-align: center;">
              ...
              <${t} tooltiptext="Right placement" placement="${n.TOOLTIP_RIGHT}" show>
            ...
            <div style="text-align: center;">
              ...
              <${t} tooltiptext="Right start placement" placement="${n.TOOLTIP_RIGHT_START}" show>
            ...
            <div style="text-align: center;">
              ...
              <${t} tooltiptext="Right end placement" placement="${n.TOOLTIP_RIGHT_END}" show>
        ...
        <div>
          ...
          <div style="display: flex; gap: 40px; align-items: center;">
            <div style="text-align: center;">
              ...
              <${t} tooltiptext="Small tooltip size" placement="${n.TOOLTIP_TOP}" tooltipSize="${T.TOOLTIP_SMALL}" show>
            ...
            <div style="text-align: center;">
              ...
              <${t} tooltiptext="Medium tooltip size" placement="${n.TOOLTIP_TOP}" tooltipSize="${T.TOOLTIP_MEDIUM}" show>
        ...
        <div>
          ...
          <div style="display: flex; gap: 40px; align-items: center;">
            <div style="text-align: center;">
              ...
              <${t} tooltiptext="This is a single line tooltip that stays on one line" placement="${n.TOOLTIP_TOP}" 
        ...
        <div>
          ...
          <div style="display: flex; gap: 40px; align-items: center;">
            <div style="text-align: center;">
              ...
              <${t} tooltiptext="Tooltip with 20px gap" placement="${n.TOOLTIP_TOP}" .gap=${20} show>
            ...
            <div style="text-align: center;">
              ...
              <${t} tooltiptext="Wide tooltip" placement="${n.TOOLTIP_TOP}" .minimumWidth=${200} show>
        ...
        <div>
          ...
          <div style="display: flex; gap: 40px; align-items: center;">
            <div style="text-align: center;">
              ...
              <${t} tooltiptext="Left to right text direction" placement="${n.TOOLTIP_TOP}" show>
            ...
            <div style="text-align: center;">
              ...
              <${t} tooltiptext="مرحبا بك في التلميح" placement="${n.TOOLTIP_TOP}" ?isRTL=${!0} show>
...
}`,...(_=(m=a.parameters)==null?void 0:m.docs)==null?void 0:_.source}}};const x=["Default","AllStates"],$=Object.freeze(Object.defineProperty({__proto__:null,AllStates:a,Default:l,__namedExportsOrder:x,default:g},Symbol.toStringTag,{value:"Module"}));export{l as D,$ as E};
