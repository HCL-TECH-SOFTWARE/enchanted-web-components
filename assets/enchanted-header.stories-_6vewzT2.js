import{c as b,a5 as m,a as S,u as a,f as d,g as l,A as $,b as x,n as h,y as C,a6 as e}from"./tags-BB5KXmdF.js";import{x as O,E as w}from"./iframe-B4blCNHZ.js";import"./enchanted-textfield-D8Gz9cPJ.js";import"./enchanted-button-D6oqnDeG.js";import"./enchanted-badge-EF_sND6Q.js";import{a4 as t,H as i,d as I,E as G}from"./cssClassEnums-CY7zIYSt.js";import"./index-0ADDeSrV.js";import{t as U}from"./index-CuTRIAwF.js";import{c as V,I as B,B as M}from"./tags-C8bWlkz1.js";import"./index-COQA3Xrp.js";var _={elem:"svg",attrs:{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 32 32",fill:"currentColor",width:32,height:32},content:[{elem:"path",attrs:{d:"M18,28H14a2,2,0,0,1-2-2V18.41L4.59,11A2,2,0,0,1,4,9.59V6A2,2,0,0,1,6,4H26a2,2,0,0,1,2,2V9.59A2,2,0,0,1,27.41,11L20,18.41V26A2,2,0,0,1,18,28ZM6,6V9.59l8,8V26h4V17.59l8-8V6Z"}}],name:"filter",size:32};const D=`${B}icon-filter`;class k extends M{render(){return O`${U({..._,attrs:{..._.attrs,preserveAspectRatio:"xMidYMid"}})}`}}V&&!customElements.get(D)&&customElements.define(D,k);var L=Object.defineProperty,P=Object.getOwnPropertyDescriptor,c=(n,r,v,A)=>{for(var o=A>1?void 0:A?P(r,v):r,u=n.length-1,g;u>=0;u--)(g=n[u])&&(o=(A?g(r,v,o):g(o))||o);return A&&o&&L(r,v,o),o};const z=b("enchanted-web-components:components:atomic-component:enchanted-header.ts");let s=class extends S{constructor(){super(...arguments),this.headerTitle="",this.showBackIcon=!1,this.isSideNavOpen=!1,this.disabled=!1,this.variant=void 0}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback()}renderTitle(r){switch(r){case t.HEADER_AUTHORING:return a`${this.getMessage("header.authoring.search")}`;case t.HEADER_AUTHORING_MODAL_CLOSE:return a`${this.getMessage("header.authoring.search")}`;case t.HEADER_ENDUSER:return a`${this.getMessage("header.enduser.search.center.title")}`;default:return a`${this.headerTitle}`}}renderEndSection(r){switch(r){case t.HEADER_AUTHORING:return a`
          <${$} label=""
  ...
  name: 'Default'
}`,...(N=(H=p.parameters)==null?void 0:H.docs)==null?void 0:N.source}}};var f,R,y;E.parameters={...E.parameters,docs:{...(f=E.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: () => {
    return html\`
      <div style="display: flex; flex-direction: column; gap: 40px;">
        <div>
...
}`,...(y=(R=E.parameters)==null?void 0:R.docs)==null?void 0:y.source}}};const F=["EnchantedHeader","AllStates"],ie=Object.freeze(Object.defineProperty({__proto__:null,AllStates:E,EnchantedHeader:p,__namedExportsOrder:F,default:j},Symbol.toStringTag,{value:"Module"}));export{ie as E,p as a};
