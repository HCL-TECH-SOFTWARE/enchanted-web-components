...
**Accessibility:** All buttons include ariaLabel for screen reader support.`}}},render:()=>a`
      <div style="display: flex; gap: 32px; flex-wrap: wrap; align-items: flex-start;">
        <div>
          ...
          <${e}
            size="${i.SMALL}"
            .icon=${a`<${n("icon-search")}></${n("icon-search")}>`}
            ariaLabel="Search"
          ></${e}>
        </div>
        <div>
...
}`,...(d=(c=o.parameters)==null?void 0:c.docs)==null?void 0:d.source}}};var l,m,g;r.parameters={...r.parameters,docs:{...(l=r.parameters)==null?void 0:l.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    },
...
}`,...(g=(m=r.parameters)==null?void 0:m.docs)==null?void 0:g.source}}};const u=["Default","AllStates"],N=Object.freeze(Object.defineProperty({__proto__:null,AllStates:r,Default:o,__namedExportsOrder:u,default:p},Symbol.toStringTag,{value:"Module"}));export{o as D,N as E};
