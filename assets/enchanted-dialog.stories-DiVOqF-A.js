import{c as L,J as O,K as S,y as k,n as m,M as b,E as w,u as p,g as f,l as G,N as n}from"./tags-GuWqQq8Q.js";import{E as v}from"./iframe-DIZdwA76.js";import{l as y}from"./lodash-CdDiHlzQ.js";import"./enchanted-svg-icon-Cteqgcis.js";import"./enchanted-button-BAnGK4C4.js";import{n as t}from"./cssClassEnums-BAuKGcJP.js";import{i as C}from"./localization-CViIwzVj.js";import{K as E}from"./keyboardEventKeys-BnoN8uA3.js";import"./index-CTiHq96Y.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./preload-helper-C1FmrZbK.js";import"./state-CtyNSLbf.js";import"./query-BApjzB0v.js";import"./index-CuTRIAwF.js";import"./tags-OypiFpf3.js";var e=(i=>(i.XL="xl",i.LG="lg",i.MD="md",i.SM="sm",i.XS="xs",i.CHAT="chat",i))(e||{}),I=Object.defineProperty,B=Object.getOwnPropertyDescriptor,u=(i,o,d,a)=>{for(var l=a>1?void 0:a?B(o,d):o,c=i.length-1,s;c>=0;c--)(s=i[c])&&(l=(a?s(o,d,l):s(l))||l);return a&&l&&I(o,d,l),l};const R=L("enchanted-web-components:components:atomic-component:enchanted-dialog.ts");let r=class extends w{constructor(){super(...arguments),this.open=!1,this.size=e.XL,this.dialogTitle="",this.overrideTitle=!1,this.removeBorder=!1,this.disableBackdropClick=!1,this._debounceBackdropClick=y.debounce(o=>{this.handleBackdropClick(o)},300)}connectedCallback(){super.connectedCallback(),this.dialogTitle===""&&(this.dialogTitle=this.getMessage("generic.label"))}disconnectedCallback(){super.disconnectedCallback()}async updated(o){o.has("open")&&this.open&&(await this.updateComplete,this._focusFirstElement())}_focusFirstElement(){const o=this.renderRoot.querySelectorAll("slot");for(const l of Array.from(o)){const c=l.assignedElements({flatten:!0});for(const s of c){if(s.matches(r.FOCUSABLE_SELECTOR)){this._focusElement(s);return}const T=s.querySelector(r.FOCUSABLE_SELECTOR);if(T){this._focusElement(T);return}}}const d=this.renderRoot.querySelector(r.FOCUSABLE_SELECTOR);if(d){this._focusElement(d);return}const a=this.renderRoot.querySelector(`[part*="${this.getPaperPart()}"]`);a==null||a.focus()}_hasShadowRoot(o){return"shadowRoot"in o&&o.shadowRoot instanceof ShadowRoot}_hasRenderRoot(o){return"renderRoot"in o&&o.renderRoot instanceof ShadowRoot}_focusElement(o,d=0){if(d>=r.MAX_FOCUS_DEPTH){o.focus();return}let a=o,l=null,c=d;for(;a&&c<r.MAX_FOCUS_DEPTH;){if(this._hasShadowRoot(a)){const s=a.shadowRoot.querySelector(r.FOCUSABLE_SELECTOR);if(s){a=s,l=s,c++;continue}}else if(this._hasRenderRoot(a)){const s=a.renderRoot.querySelector(r.FOCUSABLE_SELECTOR);if(s){a=s,l=s,c++;continue}}break}(l||o).focus()}async refocusDialog(){this.open&&(await this.updateComplete,this._focusFirstElement())}handleClose(o){o.stopPropagation(),this.open=!1,this.dispatchEvent(new CustomEvent("enchanted-dialog-close",{bubbles:!0,composed:!0}))}handleBackdropClick(o){if(this.disableBackdropClick){o.stopPropagation();return}this.handleClose(o)}handleCloseByEnterKey(o){(o.key===E.ENTER||o.key===E.SPACE)&&(o.stopPropagation(),this.handleClose(o))}getContainerPart(){switch(this.size){case e.XL:return t.CONTAINER_XL;case e.XS:return t.CONTAINER_XS;case e.SM:return t.CONTAINER_SM;case e.MD:return t.CONTAINER_MD;case e.LG:return t.CONTAINER_LG;case e.CHAT:return t.CONTAINER_CHAT;default:return t.CONTAINER_XL}}getPaperPart(){switch(this.size){case e.XL:return t.PAPER_XL;case e.XS:return t.PAPER_XS;case e.SM:return t.PAPER_SM;case e.MD:return t.PAPER_MD;case e.LG:return t.PAPER_LG;case e.CHAT:return t.PAPER_CHAT;default:return t.PAPER_XL}}getContentPart(){switch(this.size){case e.XL:return this.removeBorder?t.CONTENT_XL_NO_BORDER:t.CONTENT_XL;case e.XS:return t.CONTENT_XS;case e.SM:return t.CONTENT_SM;case e.MD:return t.CONTENT_MD;case e.LG:return t.CONTENT_LG;case e.CHAT:return t.CONTENT_CHAT;default:return t.CONTENT_XL}}getPaginationPart(){switch(this.size){case e.XS:return t.PAGINATION_XS;case e.SM:return t.PAGINATION_SM;case e.MD:return t.PAGINATION_MD;case e.LG:return t.PAGINATION_LG;case e.XL:default:return t.PAGINATION_XL}}getActionPart(){return this.removeBorder?t.ACTION_NO_BORDER:this.size===e.CHAT?t.CHAT_ACTION:t.ACTION}render(){const o=this.size===e.CHAT;return this.open?p`
        <div role="presentation" part=${o?t.DIALOG_ROOT_CHAT:t.DIALOG_ROOT}>
          ${o?v:p`<div aria-hidden="true" part=${t.BACKDROP} @click=${this._debounceBackdropClick}></div>`}
          <div tabindex="-1" role="presentation" part=${this.getContainerPart()}>
            ...
            >
              <div part="${this.overrideTitle?v:t.TITLE}">
                ${this.overrideTitle?p`<slot name="title"></slot>`:p`
                    <div part=${C()?t.TITLE_ROOT:t.TITLE_ROOT_RTL}>
                      <p part=${C()?t.TITLE_TEXT:t.TITLE_TEXT_RTL}>
                        ${this.dialogTitle}
                      </p>
      ...
      `:v}};r.FOCUSABLE_SELECTOR=`${O}, ${S}, ${k}, button, input, [tabindex]:not([tabindex="-1"])`;r.MAX_FOCUS_DEPTH=10;u([m({type:Boolean,reflect:!0})],r.prototype,"open",2);u([m({type:String})],r.prototype,"size",2);u([m({type:String})],r.prototype,"dialogTitle",2);u([m({type:Boolean})],r.prototype,"overrideTitle",2);u([m({type:Boolean})],r.prototype,"removeBorder",2);u([m({type:Boolean,reflect:!0})],r.prototype,"disableBackdropClick",2);r=u([G()],r);customElements.get(b)?R("Component (%s) is currently registered and not possible to registrate again.",b):customElements.define(b,r);const ee={title:"Feedback/Enchanted Dialog",component:"enchanted-dialog",tags:["autodocs","a11y-addon"],decorators:[i=>p`
    <div 
    style="
    display: flex; 
    ...
    padding: 20px;">
      ${i()}
    </div>`],parameters:{layout:"padded",docs:{description:{component:"Dialog component for displaying modal content with backdrop overlay. Features multiple size variants (xl to xs), customizable title, slotted content areas (title, content, footer), and accessibility support with focus management and ARIA announcements. Supports keyboard navigation (Escape to close) and automatic screen reader notifications."}}},argTypes:{dialogTitle:{control:{type:"text"},description:"Title text displayed in the dialog header. Provides context about the dialog purpose. Used for accessibility (aria-label) and screen reader announcements.",table:{category:"Content",type:{summary:"string"},defaultValue:{summary:""}}},size:{control:{type:"radio"},options:[e.XL,e.LG,e.MD,e.SM,e.XS],description:"Dialog size variant controlling width and layout. Options: xl (extra large), lg (large), md (medium), sm (small), xs (extra small). Affects dialog dimensions and responsive behavior.",table:{category:"Layout",type:{summary:"DialogSizes"},defaultValue:{summary:e.XL}}},open:{control:{type:"boolean"},description:"Controls dialog visibility and open state. When true, dialog displays with backdrop overlay. Reflects to DOM attribute for CSS styling. Manages focus and ARIA announcements.",table:{category:"State",type:{summary:"boolean"},defaultValue:{summary:"false"}}},overrideTitle:{control:{type:"boolean"},description:'Enables custom title content via slot. When true, uses the "title" slot instead of dialogTitle property. Allows complex title layouts with icons, badges, or custom styling.',table:{category:"Display",type:{summary:"boolean"},defaultValue:{summary:"false"}}},removeBorder:{control:{type:"boolean"},description:"Removes the border from the dialog container. When true, displays dialog without border styling. Useful for custom styling or seamless integration with page design.",table:{category:"Styling",type:{summary:"boolean"},defaultValue:{summary:"false"}}},disableBackdropClick:{control:{type:"boolean"},description:"Prevents dialog from closing when clicking on the backdrop. When true, clicks on the backdrop will not close the dialog.",table:{category:"Behavior",type:{summary:"boolean"},defaultValue:{summary:"false"}}}},args:{dialogTitle:"Dialog Title",size:e.XL,open:!0,overrideTitle:!1,removeBorder:!1,disableBackdropClick:!1}},g={render:i=>p`
      <${n}
        .dialogTitle=${i.dialogTitle}
        .size=${i.size}
        ?open=${i.open}
        ?disableBackdropClick=${i.disableBackdropClick}
      ...
      <div style="display: flex; flex-direction: column; gap: 40px; padding: 20px;">
        <div>
          ...
          <div style="display: flex; flex-direction: column; gap: 20px;">
            <${n} .dialogTitle=${"Extra Large Dialog (XL)"} .size=${e.XL} ?open=${!0} ?disableBackdropClick=${!0}>
              <div slot="content">
            ...
            <${n} .dialogTitle=${"Large Dialog (LG)"} .size=${e.LG} ?open=${!0} ?disableBackdropClick=${!0}>
              <div slot="content">
            ...
            <${n} .dialogTitle=${"Medium Dialog (MD)"} .size=${e.MD} ?open=${!0} ?disableBackdropClick=${!0}>
              <div slot="content">
            ...
            <${n} .dialogTitle=${"Small Dialog (SM)"} .size=${e.SM} ?open=${!0} ?disableBackdropClick=${!0}>
              <div slot="content">
            ...
            <${n} .dialogTitle=${"Extra Small Dialog (XS)"} .size=${e.XS} ?open=${!0} ?disableBackdropClick=${!0}>
              <div slot="content">
        ...
        <div style="margin-top: 40px;">
          ...
          <div style="display: flex; flex-direction: column; gap: 20px;">
            <${n} .dialogTitle=${"Dialog with Custom Title Slot"} .size=${e.MD} ?open=${!0} ?overrideTitle=${!0}>
            ...
            <${n} .dialogTitle=${"Dialog without Border"} .size=${e.MD} ?open=${!0} ?removeBorder=${!0}>
              <div slot="content">
            ...
            <${n} .dialogTitle=${"Dialog with Rich Content"} .size=${e.LG} ?open=${!0} ?disableBackdropClick=${!0}>
              <div slot="content">
            ...
            <${n} .dialogTitle=${"Confirmation Dialog"} .size=${e.SM} ?open=${!0} ?disableBackdropClick=${!0}>
              <div slot="content">
    ...
    `,parameters:{layout:"fullscreen",docs:{description:{story:"Comprehensive showcase of all dialog sizes and variations. Demonstrates 5 size variants (xl, lg, md, sm, xs) and various configurations including custom title slots with overrideTitle, borderless dialogs with removeBorder, rich content forms, and confirmation dialogs. Note: All dialogs shown as open for visualization purposes. In production, typically only one dialog is open at a time with backdrop overlay."}},controls:{disable:!0}}};var $,A,x;g.parameters={...g.parameters,docs:{...($=g.parameters)==null?void 0:$.docs,source:{originalSource:`{
  render: args => {
    return html\`
  ...
  name: 'Default'
}`,...(x=(A=g.parameters)==null?void 0:A.docs)==null?void 0:x.source}}};var _,D,N;h.parameters={...h.parameters,docs:{...(_=h.parameters)==null?void 0:_.docs,source:{originalSource:`{
  render: () => {
    return html\`
      <div style="display: flex; flex-direction: column; gap: 40px; padding: 20px;">
        <div>
...
}`,...(N=(D=h.parameters)==null?void 0:D.docs)==null?void 0:N.source}}};const te=["EnchantedDialog","AllStates"];export{h as AllStates,g as EnchantedDialog,te as __namedExportsOrder,ee as default};
