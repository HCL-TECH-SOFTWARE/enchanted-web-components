import{c as g,M as h,a as b,f as t,g as E,u as p,n as r,N as n}from"./tags-CoVdckeD.js";import"./enchanted-button-D143v6g8.js";import{O as e,P as s,v as y,c as x}from"./cssClassEnums-B0FxBdGx.js";import"./index-Bv3ibheM.js";var O=Object.defineProperty,c=(i,T,m,I)=>{for(var o=void 0,v=i.length-1,A;v>=0;v--)(A=i[v])&&(o=A(T,m,o)||o);return o&&O(T,m,o),o};const D=g("enchanted-web-components:components:atomic-component:enchanted-panel.ts");class l extends b{constructor(){super(...arguments),this.open=!1,this.position=e.PANEL_LEFT,this.headerTitle="",this.ariaLabel="",this.focusPanel=!1}show(){this.open=!0}hide(){this.open=!1}_handleCloseClick(){this.hide(),this.dispatchEvent(new CustomEvent("enchantedPanelClose"))}render(){return p`
      <div
      ...
      >
        <div part=${s.PANEL_HEADER}>
          ...
          <${t}
            ...
            buttontext=""
            ?outlined="${!1}"
            .icon="${p`<${E("icon-close")} size="16" color="rgba(0, 0, 0, 0.60)"></${E("icon-close")}>`}"
    ...
    `}}c([r({type:Boolean,reflect:!0})],l.prototype,"open");c([r({type:String,reflect:!0})],l.prototype,"position");c([r({type:String})],l.prototype,"headerTitle");c([r({type:String})],l.prototype,"ariaLabel");c([r({type:Boolean})],l.prototype,"focusPanel");customElements.get(h)?D("Component (%s) is currently registered and not possible to registrate again.",h):customElements.define(h,l);const S={title:"Overlay/Enchanted Panel",tags:["a11y-addon"],decorators:[i=>p`
    ...
    `};var N,u,P;d.parameters={...d.parameters,docs:{...(N=d.parameters)==null?void 0:N.docs,source:{originalSource:"{}",...(P=(u=d.parameters)==null?void 0:u.docs)==null?void 0:P.source}}};var _,$,f,C,L;a.parameters={...a.parameters,docs:{...(_=a.parameters)==null?void 0:_.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    }
...
}`,...(f=($=a.parameters)==null?void 0:$.docs)==null?void 0:f.source},description:{story:`Comprehensive showcase of all panel states and configurations.
Demonstrates different positions, open/closed states, with/without title, and various content scenarios.`,...(L=(C=a.parameters)==null?void 0:C.docs)==null?void 0:L.description}}};const H=["Default","AllStates"],B=Object.freeze(Object.defineProperty({__proto__:null,AllStates:a,Default:d,__namedExportsOrder:H,default:S},Symbol.toStringTag,{value:"Module"}));export{d as D,B as E};
