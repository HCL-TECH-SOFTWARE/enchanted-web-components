import{c as b,M as h,a as y,f as t,g as A,u as p,n as r,N as n}from"./tags-BoxFtPAv.js";import"./enchanted-button-ClBT8-Pl.js";import{a2 as e,P as s,p as N,R as O,d as x}from"./cssClassEnums-CY7zIYSt.js";import"./index-CZiPudfq.js";var S=Object.defineProperty,c=(i,T,m,G)=>{for(var o=void 0,v=i.length-1,E;v>=0;v--)(E=i[v])&&(o=E(T,m,o)||o);return o&&S(T,m,o),o};const D=b("enchanted-web-components:components:atomic-component:enchanted-panel.ts");class l extends y{constructor(){super(...arguments),this.open=!1,this.position=e.PANEL_LEFT,this.headerTitle="",this.ariaLabel="",this.focusPanel=!1}show(){this.open=!0}hide(){this.open=!1}_handleCloseClick(){this.hide(),this.dispatchEvent(new CustomEvent("enchantedPanelClose"))}render(){return p`
      <div
        part=${s.PANEL_CONTAINER}
        role="dialog"
        aria-modal="true"
      ...
      >
        <div part=${s.PANEL_HEADER}>
          <div part=${s.PANEL_TITLE}>
            <span>${this.headerTitle}</span>
          </div>
          <div>
            <slot name="${N.CENTER_TITLE_CONTENT}"></slot>
          </div>
          <${t}
            part=${s.PANEL_CLOSE_BUTTON}
            exportparts="${Object.values(x).join(",")}"
            buttontext=""
            ?outlined="${!1}"
            .icon="${p`<${A("icon-close")} size="16" color="rgba(0, 0, 0, 0.60)"></${A("icon-close")}>`}"
            @click=${this._handleCloseClick}
            variant=${O.BUTTON_TEXT_VAR}
          >
          </${t}>
        </div>
        <div part=${s.PANEL_CONTENT} tabindex="-1">
          <slot name="${N.CONTENT}"></slot>
        </div>
      </div>
    `}}c([r({type:Boolean,reflect:!0})],l.prototype,"open");c([r({type:String,reflect:!0})],l.prototype,"position");c([r({type:String})],l.prototype,"headerTitle");c([r({type:String})],l.prototype,"ariaLabel");c([r({type:Boolean})],l.prototype,"focusPanel");customElements.get(h)?D("Component (%s) is currently registered and not possible to registrate again.",h):customElements.define(h,l);const H={title:"Overlay/Enchanted Panel",tags:["a11y-addon"],decorators:[i=>p`
    <div style="position: relative; min-height: 200px; width: 100%;">
      ${i()}
    </div>`],argTypes:{open:{control:{type:"boolean"},description:"Whether the panel is open",table:{category:"State",type:{summary:"boolean"},defaultValue:{summary:"false"}}},title:{control:{type:"text"},description:"Panel title",table:{category:"Content",type:{summary:"string"},defaultValue:{summary:""}}},position:{control:{type:"radio"},options:[e.PANEL_LEFT,e.PANEL_RIGHT],description:"Panel position",table:{type:{summary:"string"},defaultValue:{summary:e.PANEL_LEFT}}}},args:{open:!0,title:"Panel Title",position:e.PANEL_LEFT},render:i=>p`
      <${n}
        ?open=${i.open}
        title="${i.title}"
        position="${i.position}"
    ...
    `},d={},a={parameters:{controls:{disable:!0}},render:()=>p`
      <style>
        .panel-container {
          display: flex;
    ...
    `};var u,P,_;d.parameters={...d.parameters,docs:{...(u=d.parameters)==null?void 0:u.docs,source:{originalSource:"{}",...(_=(P=d.parameters)==null?void 0:P.docs)==null?void 0:_.source}}};var $,f,C,L,g;a.parameters={...a.parameters,docs:{...($=a.parameters)==null?void 0:$.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    }
...
}`,...(C=(f=a.parameters)==null?void 0:f.docs)==null?void 0:C.source},description:{story:`Comprehensive showcase of all panel states and configurations.
Demonstrates different positions, open/closed states, with/without title, and various content scenarios.`,...(g=(L=a.parameters)==null?void 0:L.docs)==null?void 0:g.description}}};const I=["Default","AllStates"],U=Object.freeze(Object.defineProperty({__proto__:null,AllStates:a,Default:d,__namedExportsOrder:I,default:H},Symbol.toStringTag,{value:"Module"}));export{d as D,U as E};
