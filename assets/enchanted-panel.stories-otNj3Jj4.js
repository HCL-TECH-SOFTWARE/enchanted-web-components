import{x as r}from"./iframe-DHDpWj8R.js";import{n as d,t as E,E as C}from"./enchanted-ac-base-element-DiERHT3A.js";import"./enchanted-button-CLWRKz3u.js";import{P as n,o,g as N,i as _}from"./cssClassEnums-D4dgqifY.js";import"./index-CBZgaqBm.js";import"./preload-helper-C1FmrZbK.js";import"./state-CAzxSWuk.js";import"./localization-Dlp2bMpu.js";import"./index-BdjfDspd.js";var $=Object.defineProperty,y=Object.getOwnPropertyDescriptor,a=(i,s,v,p)=>{for(var e=p>1?void 0:p?y(s,v):s,h=i.length-1,u;h>=0;h--)(u=i[h])&&(e=(p?u(s,v,e):u(e))||e);return p&&e&&$(s,v,e),e};let t=class extends C{constructor(){super(...arguments),this.open=!1,this.position=n.PANEL_LEFT,this.headerTitle="",this.ariaLabel="",this.focusPanel=!1}show(){this.open=!0}hide(){this.open=!1}_handleCloseClick(){this.hide(),this.dispatchEvent(new CustomEvent("enchantedPanelClose"))}render(){return r`
      <div
