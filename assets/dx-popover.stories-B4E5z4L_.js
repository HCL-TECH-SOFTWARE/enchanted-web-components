import{E as u,x as p}from"./iframe-Dsd1MpWQ.js";import{n as a,t as f,D as L,L as P}from"./dx-ac-base-element-C9dhstFR.js";import"./index-DBmzuMS8.js";import{g as R}from"./localization-DmqTGOFp.js";import{q as n}from"./cssClassEnums-v1h5zF5X.js";import"./dx-button-gwJQrlvi.js";import"./preload-helper-C1FmrZbK.js";import"./index-BPZZDKKN.js";import"./state-DQlunuPl.js";var _=Object.defineProperty,A=Object.getOwnPropertyDescriptor,r=(e,d,x,l)=>{for(var i=l>1?void 0:l?A(d,x):d,h=e.length-1,b;h>=0;h--)(b=e[h])&&(i=(l?b(d,x,i):b(i))||i);return l&&i&&_(d,x,i),i};let o=class extends L{constructor(){super(...arguments),this.open=!1,this.label="Label",this.text="Text",this.showLabel=!1,this.showText=!1,this.showCloseIcon=!1,this.inverse=!1,this.withpadding=!1,this.disableHover=!1,this._showPopover=()=>{this.disableHover||(this.open=!0)},this._hidePopover=()=>{this.disableHover||(this.open=!1)},this._onCloseClick=e=>{e.stopPropagation(),this.open=!1}}get isLTR(){return R()===P.LTR}render(){return p`
    <div id="target" part="${n.POPOVER_TARGET}" aria-label=${this.label}>
      <slot
        name="target"
    ...
    <div part="${n.POPOVER_WRAPPER}" ?inverse=${this.inverse} aria-label=${this.label}>
      ${this.arrow?p`
      <div part="${n.POPOVER_ARROW}"></div>`:u}
        <div part=${this.isLTR?n.POPOVER_CONTAINER:n.POPOVER_CONTAINER_RTL}>
          <div part="${n.POPOVER_CONTENT}">
            ${this.showLabel?p`<div part="${n.POPOVER_LABEL}"><slot name="label">${this.label}</slot></div>`:u}
            ${this.showText?p`<div part="${n.POPOVER_TEXT}"><slot name="text">${this.text}</slot></div>`:u}
            
          </div>
          ${this.showCloseIcon?p`<button part=${this.isLTR?n.POPOVER_CLOSE_ICON:n.POPOVER_CLOSE_ICON_RTL} 
  ...
  `};var w,$,c;v.parameters={...v.parameters,docs:{...(w=v.parameters)==null?void 0:w.docs,source:{originalSource:`{
  name: 'Default',
  render: args => {
    return html\`
    <dx-popover
...
}`,...(c=($=v.parameters)==null?void 0:$.docs)==null?void 0:c.source}}};var T,g,m,y,O;s.parameters={...s.parameters,docs:{...(T=s.parameters)==null?void 0:T.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    }
...
}`,...(m=(g=s.parameters)==null?void 0:g.docs)==null?void 0:m.source},description:{story:`Comprehensive showcase of all popover states and arrow positions.
...
- Label and text visibility combinations`,...(O=(y=s.parameters)==null?void 0:y.docs)==null?void 0:O.description}}};const F=["DxPopoverStory","AllStates"];export{s as AllStates,v as DxPopoverStory,F as __namedExportsOrder,M as default};
