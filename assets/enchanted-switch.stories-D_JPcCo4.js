import{c as y,R as c,a as T,n as C,S as i,u as E}from"./tags-CoVdckeD.js";import{E as w,x as S}from"./iframe-q8uLr7wl.js";import{l as k}from"./lodash-CdDiHlzQ.js";import{l as s}from"./cssClassEnums-B0FxBdGx.js";import{K as p}from"./keyboardEventKeys-BnoN8uA3.js";var _=Object.defineProperty,D=(n,t,e,$)=>{for(var a=void 0,d=n.length-1,h;d>=0;d--)(h=n[d])&&(a=h(t,e,a)||a);return a&&_(t,e,a),a};const A=y("enchanted-web-components:components:atomic-component:enchanted-switch.ts");class l extends T{constructor(){super(...arguments),this.isChecked=!1,this.isDisabled=!1}partAttributeDecider(t){let e=t;switch(t){case s.SWITCH_SLIDER:return this.isChecked?(e=s.SWITCH_SLIDER_CHECKED,this.isDisabled&&(e=s.SWITCH_SLIDER_CHECKED_DISABLED)):this.isDisabled&&(e=s.SWITCH_SLIDER_DISABLED),e;case s.SWITCH_LABEL:return this.isDisabled&&(e=s.SWITCH_LABEL_DISABLED),e;case s.SWITCH_INPUT:return e;default:return e}}handleSwitchToggle(t){t.stopPropagation(),this.isChecked=!this.isChecked;const e=new CustomEvent("change",{detail:{isChecked:this.isChecked}});this.dispatchEvent(e)}pressKeyHandler(t){const e=t;(e.key===p.ENTER||e.key==p.SPACE)&&(t.preventDefault(),this.handleSwitchToggle(t))}render(){return S`
    <label
...
**Events:** Toggleable switches dispatch change events with the new isChecked state, enabling reactive behavior in applications.`}}},render:()=>E`
    ...
    `};var b,u,m;r.parameters={...r.parameters,docs:{...(b=r.parameters)==null?void 0:b.docs,source:{originalSource:"{}",...(m=(u=r.parameters)==null?void 0:u.docs)==null?void 0:m.source}}};var g,v,f;o.parameters={...o.parameters,docs:{...(g=o.parameters)==null?void 0:g.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    },
...
}`,...(f=(v=o.parameters)==null?void 0:v.docs)==null?void 0:f.source}}};const H=["Default","AllStates"],G=Object.freeze(Object.defineProperty({__proto__:null,AllStates:o,Default:r,__namedExportsOrder:H,default:I},Symbol.toStringTag,{value:"Module"}));export{r as D,G as E};
