import{c as B,O as f,E as I,P as A,u as o,n as r,Q as a,k as i,g as e}from"./tags-GuWqQq8Q.js";import{F as c,E as b,g,h as u}from"./cssClassEnums-BAuKGcJP.js";import"./index-DcBEPz3N.js";import"./enchanted-badge-B982anGm.js";import"./iframe-DIZdwA76.js";import"./preload-helper-C1FmrZbK.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./state-CtyNSLbf.js";import"./localization-CViIwzVj.js";import"./tags-OypiFpf3.js";var D=Object.defineProperty,d=(t,s,p,C)=>{for(var n=void 0,m=t.length-1,x;m>=0;m--)(x=t[m])&&(n=x(s,p,n)||n);return n&&D(s,p,n),n};const k=B("enchanted-web-components:components:atomic-component:enchanted-fab-ai.ts");class l extends I{constructor(){super(...arguments),this.extended=!1,this.disabled=!1,this.label="",this.badge=!1}render(){return o`
      <${A}
  ...
  `,parameters:{controls:{disable:!0}}};var E,h,T;$.parameters={...$.parameters,docs:{...(E=$.parameters)==null?void 0:E.docs,source:{originalSource:"{}",...(T=(h=$.parameters)==null?void 0:h.docs)==null?void 0:T.source}}};var _,N,v;y.parameters={...y.parameters,docs:{...(_=y.parameters)==null?void 0:_.docs,source:{originalSource:`{
  render: () => {
    return html\`
    <div style="position: relative; display: flex; flex-wrap: wrap; gap: 10px; padding: 20px;">
      <!-- AI Button States (Extended EnchantedFab) -->
...
}`,...(v=(N=y.parameters)==null?void 0:N.docs)==null?void 0:v.source}}};const R=["Default","AllStates"];export{y as AllStates,$ as Default,R as __namedExportsOrder,P as default};
