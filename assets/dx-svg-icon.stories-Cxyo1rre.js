import{x as c}from"./iframe-Dsd1MpWQ.js";import"./dx-svg-icon-9LpOfG7A.js";import"./preload-helper-C1FmrZbK.js";import"./dx-ac-base-element-C9dhstFR.js";const n=c`
   <svg
     width="16"
     height="16"
     viewBox="0 0 16 16"
 ...
 `,C={title:"Icon/dx-svg-icon",component:"dx-svg-icon",tags:["autodocs"],parameters:{docs:{description:{component:"The SVG Icon component renders SVG templates with customizable color and size properties. It supports parent color inheritance via useCurrentColor for seamless integration with text and UI elements. Use this component for consistent icon rendering across your application with flexible styling options."}}},argTypes:{icon:{control:{type:"object"},description:"SVG icon template (TemplateResult) to be rendered. Pass a Lit template containing the SVG markup. Required for the icon to display."},color:{control:{type:"color"},description:"Custom color for the icon. Overrides default styling. Ignored when useCurrentColor is true. Accepts any valid CSS color value (hex, rgb, named colors).",table:{category:"Styling",type:{summary:"string"},defaultValue:{summary:""}}},size:{control:{type:"text"},description:'Icon size applied to both width and height. Accepts CSS size values (px, em, rem, %). Example: "24px", "2rem". Ensures consistent aspect ratio.',table:{category:"Layout",type:{summary:"string"},defaultValue:{summary:"16px"}}},useCurrentColor:{control:{type:"boolean"},description:"When true, icon inherits color from parent element. Useful for matching icon color with surrounding text or UI components. Overrides color property.",table:{category:"Styling",type:{summary:"boolean"},defaultValue:{summary:"false"}}}},args:{icon:n,color:"",size:"16px",useCurrentColor:!1}},o={name:"dx-svg-icon",render:i=>c`
    ...
    `},s={parameters:{controls:{disable:!0}},render:()=>c`
      ...
      <div class="icon-container">
        ...
        <div class="icon-section">
          ...
          <div class="icon-row">
            <div class="icon-item">
              <dx-svg-icon .icon=${n}></dx-svg-icon>
        ...
        <div class="icon-section">
          ...
          <div class="icon-row">
            <div class="icon-item">
              <dx-svg-icon .icon=${n} color="red"></dx-svg-icon>
              <span class="icon-label">Red</span>
            </div>
            <div class="icon-item">
              <dx-svg-icon .icon=${n} color="blue"></dx-svg-icon>
              <span class="icon-label">Blue</span>
            </div>
            <div class="icon-item">
              <dx-svg-icon .icon=${n} color="green"></dx-svg-icon>
              <span class="icon-label">Green</span>
            </div>
            <div class="icon-item">
              <dx-svg-icon .icon=${n} color="#FF6B35"></dx-svg-icon>
              <span class="icon-label">Hex Color</span>
            </div>
            <div class="icon-item">
              <dx-svg-icon .icon=${n} color="rgb(138, 43, 226)"></dx-svg-icon>
              <span class="icon-label">RGB Color</span>
            </div>
            <div class="icon-item">
              <dx-svg-icon .icon=${n} color="rgba(255, 99, 71, 0.6)"></dx-svg-icon>
        ...
        <div class="icon-section">
          ...
          <div class="icon-row">
            <div class="icon-item">
              <dx-svg-icon .icon=${n} size="12px"></dx-svg-icon>
              <span class="icon-label">12px (small)</span>
            </div>
            <div class="icon-item">
              <dx-svg-icon .icon=${n} size="16px"></dx-svg-icon>
              <span class="icon-label">16px (default)</span>
            </div>
            <div class="icon-item">
              <dx-svg-icon .icon=${n} size="24px"></dx-svg-icon>
              <span class="icon-label">24px</span>
            </div>
            <div class="icon-item">
              <dx-svg-icon .icon=${n} size="32px"></dx-svg-icon>
              <span class="icon-label">32px</span>
            </div>
            <div class="icon-item">
              <dx-svg-icon .icon=${n} size="48px"></dx-svg-icon>
              <span class="icon-label">48px</span>
            </div>
            <div class="icon-item">
              <dx-svg-icon .icon=${n} size="64px"></dx-svg-icon>
              <span class="icon-label">64px (large)</span>
            </div>
            <div class="icon-item">
              <dx-svg-icon .icon=${n} size="2rem"></dx-svg-icon>
              <span class="icon-label">2rem</span>
            </div>
            <div class="icon-item">
              <dx-svg-icon .icon=${n} size="3em"></dx-svg-icon>
          ...
          <div class="icon-row">
            <div class="icon-item">
              <span style="color: green; font-size: 24px;">
                <dx-svg-icon .icon=${n} ?useCurrentColor=${!0}></dx-svg-icon>
              </span>
        ...
        <div class="icon-section">
          ...
          <div class="icon-row">
            <div class="icon-item">
              <dx-svg-icon .icon=${n} color="crimson" size="32px"></dx-svg-icon>
              <span class="icon-label">Color + Size</span>
            </div>
            <div class="icon-item">
              <dx-svg-icon .icon=${n} color="teal" size="48px"></dx-svg-icon>
              <span class="icon-label">Teal + 48px</span>
            </div>
            <div class="icon-item">
              <dx-svg-icon .icon=${n} color="#4CAF50" size="24px"></dx-svg-icon>
              <span class="icon-label">Hex + 24px</span>
            </div>
            <div class="icon-item">
              <span style="color: indigo; font-size: 48px;">
                <dx-svg-icon .icon=${n} size="48px" ?useCurrentColor=${!0}></dx-svg-icon>
              </span>
    ...
    `};var e,a,l;o.parameters={...o.parameters,docs:{...(e=o.parameters)==null?void 0:e.docs,source:{originalSource:`{
  name: 'dx-svg-icon',
  render: args => {
    return html\`
      <dx-svg-icon
...
}`,...(l=(a=o.parameters)==null?void 0:a.docs)==null?void 0:l.source}}};var r,t,d,p,v;s.parameters={...s.parameters,docs:{...(r=s.parameters)==null?void 0:r.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    }
      ...
      <div class="icon-container">
        ...
        <div class="icon-section">
          ...
          <div class="icon-row">
            ...
            <div class="icon-item">
              <dx-svg-icon .icon=\${svgIconEnd} color="blue"></dx-svg-icon>
              <span class="icon-label">Blue</span>
            </div>
            <div class="icon-item">
              <dx-svg-icon .icon=\${svgIconEnd} color="green"></dx-svg-icon>
              <span class="icon-label">Green</span>
            </div>
            <div class="icon-item">
              <dx-svg-icon .icon=\${svgIconEnd} color="#FF6B35"></dx-svg-icon>
              <span class="icon-label">Hex Color</span>
            </div>
            <div class="icon-item">
              <dx-svg-icon .icon=\${svgIconEnd} color="rgb(138, 43, 226)"></dx-svg-icon>
              <span class="icon-label">RGB Color</span>
            </div>
            <div class="icon-item">
              <dx-svg-icon .icon=\${svgIconEnd} color="rgba(255, 99, 71, 0.6)"></dx-svg-icon>
              <span class="icon-label">RGBA (transparent)</span>
            </div>
          </div>
        </div>
        ...
        <div class="icon-section">
          ...
          <div class="icon-row">
            <div class="icon-item">
              <dx-svg-icon .icon=\${svgIconEnd} size="12px"></dx-svg-icon>
              <span class="icon-label">12px (small)</span>
            </div>
            <div class="icon-item">
              <dx-svg-icon .icon=\${svgIconEnd} size="16px"></dx-svg-icon>
              <span class="icon-label">16px (default)</span>
            </div>
            <div class="icon-item">
              <dx-svg-icon .icon=\${svgIconEnd} size="24px"></dx-svg-icon>
              <span class="icon-label">24px</span>
            </div>
            <div class="icon-item">
              <dx-svg-icon .icon=\${svgIconEnd} size="32px"></dx-svg-icon>
              <span class="icon-label">32px</span>
            </div>
            <div class="icon-item">
            ...
            <div class="icon-item">
              <dx-svg-icon .icon=\${svgIconEnd} size="64px"></dx-svg-icon>
              <span class="icon-label">64px (large)</span>
            </div>
            <div class="icon-item">
              <dx-svg-icon .icon=\${svgIconEnd} size="2rem"></dx-svg-icon>
              <span class="icon-label">2rem</span>
            </div>
            <div class="icon-item">
              <dx-svg-icon .icon=\${svgIconEnd} size="3em"></dx-svg-icon>
              <span class="icon-label">3em</span>
            </div>
          </div>
        </div>
        ...
        <div class="icon-section">
          ...
          <div class="icon-row">
            <div class="icon-item">
              <span style="color: green; font-size: 24px;">
                <dx-svg-icon .icon=\${svgIconEnd} ?useCurrentColor=\${true}></dx-svg-icon>
              </span>
              <span class="icon-label">Green parent</span>
            </div>
            <div class="icon-item">
        ...
        <div class="icon-section">
          ...
          <div class="icon-row">
            <div class="icon-item">
              <dx-svg-icon .icon=\${svgIconEnd} color="crimson" size="32px"></dx-svg-icon>
              <span class="icon-label">Color + Size</span>
            </div>
            <div class="icon-item">
              <dx-svg-icon .icon=\${svgIconEnd} color="teal" size="48px"></dx-svg-icon>
              <span class="icon-label">Teal + 48px</span>
            </div>
            <div class="icon-item">
              <dx-svg-icon .icon=\${svgIconEnd} color="#4CAF50" size="24px"></dx-svg-icon>
              <span class="icon-label">Hex + 24px</span>
            </div>
            <div class="icon-item">
              <span style="color: indigo; font-size: 48px;">
                <dx-svg-icon .icon=\${svgIconEnd} size="48px" ?useCurrentColor=\${true}></dx-svg-icon>
              </span>
              <span class="icon-label">Parent color + size</span>
            </div>
            <div class="icon-item">
...
}`,...(d=(t=s.parameters)==null?void 0:t.docs)==null?void 0:d.source},description:{story:`Comprehensive showcase of all svg-icon states and styling options.
Demonstrates default rendering, custom colors, various sizes, and parent color inheritance.`,...(v=(p=s.parameters)==null?void 0:p.docs)==null?void 0:v.description}}};const b=["DxSvgIconStory","AllStates"];export{s as AllStates,o as DxSvgIconStory,b as __namedExportsOrder,C as default};
