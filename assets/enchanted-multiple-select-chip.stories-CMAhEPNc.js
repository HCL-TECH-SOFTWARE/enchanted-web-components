import{c as U,a7 as _,a as R,x as f,r as v,w as k,g as E,u as p,i as L,f as y,o as g,q as S,n as u,y as G,a8 as i}from"./tags-BB5KXmdF.js";import{x as W,E as $}from"./iframe-B4blCNHZ.js";import{r as I}from"./state-B-Bwqa8u.js";import{l as B}from"./lodash-CdDiHlzQ.js";import"./index-CKFmveJg.js";import"./enchanted-button-D6oqnDeG.js";import{I as l,l as q,C as z,d as j,L as K}from"./cssClassEnums-CY7zIYSt.js";import{I as X}from"./exportParts-CSCHC3ow.js";import{K as n}from"./keyboardEventKeys-BnoN8uA3.js";import"./index-C7HrrR8w.js";import"./index-B_1Ya4AQ.js";import"./index-CWwr-8yc.js";import{t as Y}from"./index-CuTRIAwF.js";import{c as J,I as Q,B as Z}from"./tags-C8bWlkz1.js";var N={elem:"svg",attrs:{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 32 32",fill:"currentColor",width:32,height:32},content:[{elem:"path",attrs:{d:"M16,2C8.2,2,2,8.2,2,16s6.2,14,14,14s14-6.2,14-14S23.8,2,16,2z M21.4,23L16,17.6L10.6,23L9,21.4l5.4-5.4L9,10.6L10.6,9	l5.4,5.4L21.4,9l1.6,1.6L17.6,16l5.4,5.4L21.4,23z"}},{elem:"path",attrs:{d:"M14.4 16L9 10.6 10.6 9 16 14.4 21.4 9 23 10.6 17.6 16 23 21.4 21.4 23 16 17.6 10.6 23 9 21.4 14.4 16","data-icon-path":"inner-path",opacity:"0"}}],name:"close--filled",size:32};const D=`${Q}icon-close-filled`;class ee extends Z{render(){return W`${Y({...N,attrs:{...N.attrs,preserveAspectRatio:"xMidYMid"}})}`}}J&&!customElements.get(D)&&customElements.define(D,ee);var te=Object.defineProperty,se=Object.getOwnPropertyDescriptor,c=(e,t,a,d)=>{for(var m=d>1?void 0:d?se(t,a):t,r=e.length-1,h;r>=0;r--)(h=e[r])&&(m=(d?h(t,a,m):h(m))||m);return d&&m&&te(t,a,m),m};const le=U("enchanted-web-components:components:atomic-component:enchanted-multiple-select-chip.ts");let o=class extends R{constructor(){super(...arguments),this.toggleDropDown=!1,this.currentFocusedItem=void 0,this.inputValue="",this.onInputHover=!1,this.isInputFocused=!1,this.isClearAllIconFocused=!1,this.disabled=!1,this.showHelperText=!1,this.helperText="",this.name="multiple-select",this.selectedValues=[],this.options=[],this.field="",this.showRemoveLabel=!1,this.emptyOptions=!1,this.clearIcon=!0,this.placeholder=this.getMessage("authoring.multi.select.placeholder"),this.label=this.getMessage("authoring.multi.select.label"),this.handleOutsideClick=e=>{const t=e.target;!this.contains(t)&&this.toggleDropDown&&(this.toggleDropDown=!1,this.inputValue="",this.requestUpdate())}}focusListItem(e){if(!e)return;const t=e;if(typeof t.focusListItem=="function"){t.focusListItem();return}t.focus()}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.handleDropdownNav),document.addEventListener("click",this.handleOutsideClick)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("keydown",this.handleDropdownNav),document.removeEventListener("click",this.handleOutsideClick)}handleListItemClick(e){var h;e.stopPropagation();const t=e.currentTarget,a=(h=t.textContent)==null?void 0:h.trim(),d=t.getAttribute("id")||a;if(!d||!a)return;if(this.selectedValues.find(T=>T.id===d))this.selectedValues=this.selectedValues.filter(T=>T.id!==d);else{const T=this.options.find(M=>M.id===d);T&&(this.selectedValues=[...this.selectedValues,{id:T.id,name:T.name,value:T.value}])}this.inputValue="",this.toggleDropDown=!0;const r=this.renderRoot.querySelector(`#${l.INPUT_FIELD}`);r&&r.focus(),this.currentFocusedItem=t,this.dispatchChangeEvent(),this.requestUpdate()}handleChipRemove(e,t){e.stopPropagation(),this.selectedValues=this.selectedValues.filter(d=>d.id!==t),this.dispatchChangeEvent(),this.requestUpdate();const a=this.renderRoot.querySelector(`#${l.INPUT_FIELD}`);a&&a.focus()}handleClearAll(){const e=this.toggleDropDown;this.selectedValues=[],this.inputValue="",this.dispatchChangeEvent(),this.toggleDropDown=e,this.requestUpdate();const t=this.renderRoot.querySelector(`#${l.INPUT_FIELD}`);t&&t.focus()}handleInput(e){e.stopPropagation();const t=e.target;this.inputValue=t.value,this.toggleDropDown||(this.toggleDropDown=!0),this.dispatchEvent(new CustomEvent("input",{detail:{value:this.inputValue,type:this.field},bubbles:!0,composed:!0}))}getDivInputParts(){let e=l.INPUT_CONTAINER;return this.disabled&&(e=`${e} ${l.INPUT_CONTAINER_DISABLED}`),e}handleInputKeyDown(e){e.stopPropagation(),e.key===n.ENTER||e.key===n.SPACE?(e.preventDefault(),this.disabled||(this.emptyOptions&&this.inputValue&&e.key===n.ENTER?(this.selectedValues=[...this.selectedValues,{id:this.inputValue,name:this.inputValue,value:this.inputValue}],this.inputValue="",this.dispatchChangeEvent(),this.requestUpdate()):(this.toggleDropDown=!this.toggleDropDown,this.toggleDropDown&&(this.listItems=Array.from(this.renderRoot.querySelectorAll(f)),this.listItems.length>0&&(this.currentFocusedItem=this.listItems[0],this.focusListItem(this.currentFocusedItem))),this.requestUpdate()))):(e.key===n.BACKSPACE||e.key===n.DELETE)&&!this.inputValue&&this.selectedValues.length>0?(this.selectedValues=this.selectedValues.slice(0,-1),this.dispatchChangeEvent(),this.requestUpdate()):e.key===n.ARROW_DOWN&&this.toggleDropDown?(e.preventDefault(),this.listItems=Array.from(this.renderRoot.querySelectorAll(f)),this.listItems.length>0&&(this.currentFocusedItem=this.listItems[0],this.focusListItem(this.currentFocusedItem))):e.key===n.ESCAPE&&this.toggleDropDown&&(e.preventDefault(),this.toggleDropDown=!1)}dispatchChangeEvent(){const e=this.selectedValues.map(t=>({id:t.id,name:t.name||t.id,value:t.value||t.id}));this.dispatchEvent(new CustomEvent("change",{detail:{value:e,type:this.field}})),this.toggleDropDown=!1}async handleButtonClick(e){e.stopPropagation(),e.preventDefault(),!this.disabled&&(this.toggleDropDown=!this.toggleDropDown,await this.updateComplete&&this.toggleDropDown&&(this.listItems=Array.from(this.renderRoot.querySelectorAll(f)),this.listItems.length>0&&(this.currentFocusedItem=this.listItems[0],this.focusListItem(this.currentFocusedItem))))}handleInputContainerClick(e){e.stopPropagation();const t=this.renderRoot.querySelector(`#${l.INPUT_FIELD}`);t&&!this.disabled&&e.target!==this.renderRoot.querySelector(`#${l.CLEAR}`)&&(t.focus(),this.toggleDropDown=!this.toggleDropDown,this.requestUpdate())}async handleDropdownNav(e){if(e.key===n.ESCAPE&&this.toggleDropDown){e.preventDefault(),this.toggleDropDown=!1,this.requestUpdate();const t=this.renderRoot.querySelector(`#${l.INPUT_FIELD}`);t&&t.focus();return}if(!(!this.toggleDropDown||!this.listItems))switch(e.key){case n.ARROW_DOWN:{e.preventDefault(),this.listItems=Array.from(this.renderRoot.querySelectorAll(f));const t=this.currentFocusedItem?this.listItems.indexOf(this.currentFocusedItem):-1;t<this.listItems.length-1&&(this.currentFocusedItem=this.listItems[t+1],this.focusListItem(this.currentFocusedItem),this.toggleDropDown=!0);break}case n.ARROW_UP:{e.preventDefault();const t=this.currentFocusedItem?this.listItems.indexOf(this.currentFocusedItem):-1;t>0&&(this.currentFocusedItem=this.listItems[t-1],this.focusListItem(this.currentFocusedItem),this.toggleDropDown=!0);break}case n.ENTER:{e.preventDefault(),await this.updateComplete&&(this.listItems=Array.from(this.renderRoot.querySelectorAll(f))),this.currentFocusedItem&&this.currentFocusedItem.click();break}case n.TAB:{this.listItems=Array.from(this.renderRoot.querySelectorAll(f)),(this.currentFocusedItem?this.listItems.indexOf(this.currentFocusedItem):-1)===0&&(this.toggleDropDown=!1,this.requestUpdate());break}}}handleRemoveLabelClick(e){e.stopPropagation(),this.dispatchEvent(new CustomEvent("remove",{bubbles:!0,detail:{name:this.name,type:this.field}}))}getOptionName(e){return typeof e=="string"?e:e.name||e.id}handleOnMouseOver(e){e.stopPropagation(),e.preventDefault(),this.onInputHover=!0,this.requestUpdate()}handleOnMouseOut(e){e.stopPropagation(),this.onInputHover=!1,this.requestUpdate()}getPartClearAllIcon(){return(this.onInputHover||this.isInputFocused||this.isClearAllIconFocused)&&this.selectedValues.length>0?l.CLEAR_ALL_ICON:l.CLEAR_ALL_ICON_HIDDEN}getSelectedOption(e){const t=typeof e=="string"?e:e.id||e.name;return p`
    <${v}
    ...
    >
      <div part="${l.LIST_ITEM_CONTENT}">
        ...
        >
          ${this.selectedValues.some(a=>a.id===t)?p`<${E("icon-checkmark")} size="16" alt="Selected" color="rgba(0, 0, 0, 0.60)"></${E("icon-checkmark")}>`:$}
        </div>
  ...
  `}renderChips(){return p`
    ${this.selectedValues.map(e=>{const{id:t,name:a=""}=e;return p`
        <${L}
          name="${a}"
        ...
        >
          ${this.clearIcon?p`
                <span
                  ...
                  @keydown=${d=>{(d.key===n.ENTER||d.key===n.SPACE)&&(d.preventDefault(),this.handleChipRemove(d,t))}}
                  @click=${d=>this.handleChipRemove(d,t)}
                >
                  <${E("icon-close")} size="16" alt="Clear icon" color="rgba(0, 0, 0, 0.60)"></${E("icon-close")}>
                </span>
              `:$}
        </${L}>
      `})}
  `}render(){const e=this.inputValue?this.options.filter(t=>this.getOptionName(t).toLowerCase().includes(this.inputValue.toLowerCase())):this.options;return p`
    <div
    ...
    > <div part="${l.MULTIPLE_SELECT_DIV_LABEL_AND_REMOVE}">
        ...
        ${this.showRemoveLabel?p`
          <label data-testid="multiple-select-remove-label"
            ...
            @click=${this.disabled?$:this.handleRemoveLabelClick}
      ...
      <div
        ...
        @click=${t=>{document.querySelectorAll(_).forEach(a=>{a!==this&&a.toggleDropDown&&(a.toggleDropDown=!1)}),this.handleInputContainerClick(t)}}
        @keydown=${t=>{const a=t.composedPath(),d=a.some(r=>{var h;return((h=r==null?void 0:r.getAttribute)==null?void 0:h.call(r,"data-testid"))==="enchanted-multi-select-button"}),m=a.some(r=>{var h;return((h=r==null?void 0:r.getAttribute)==null?void 0:h.call(r,"data-testid"))==="enchanted-multi-select-clear-all-button"});if(!(d||m)&&(t.key===n.ENTER||t.key===n.SPACE)&&!this.disabled){t.preventDefault(),this.toggleDropDown=!this.toggleDropDown,this.toggleDropDown&&(this.listItems=Array.from(this.renderRoot.querySelectorAll(f)),this.listItems.length>0&&(this.currentFocusedItem=this.listItems[0],this.focusListItem(this.currentFocusedItem)));const r=this.renderRoot.querySelector(`#${l.INPUT_FIELD}`);r&&r.focus(),this.requestUpdate()}}}
      >
        <div
        ...
        <div part="${l.CLEAR_AND_ICON_CONTAINER}">
          ${this.selectedValues.length>0?p`
              <${g}
                part="${this.getPartClearAllIcon()}"
                .icon="${p`<${E("icon-close-filled")} size="16" color="rgba(0, 0, 0, 0.60)"></${E("icon-close-filled")}>`}"
                title="${l.CLEAR}"
                id="${l.CLEAR}"
            ...
            `:$}
          <${y}
            @click=${t=>{document.querySelectorAll(_).forEach(a=>{a!==this&&a.toggleDropDown&&(a.toggleDropDown=!1)}),this.handleButtonClick(t)}}
          
            @keydown=${t=>{if(t.key===n.SPACE&&(t.preventDefault(),this.handleButtonClick(t)),t.key===n.TAB&&this.toggleDropDown){this.toggleDropDown=!1;return}}}
            exportparts="${Object.values(j).join(",")}"
            data-testid="enchanted-multi-select-button"
            variant="button"
            .icon="${this.toggleDropDown?p`<${E("icon-caret-up")} size="16" color="rgba(0, 0, 0, 0.60)"></${E("icon-caret-up")}>`:p`<${E("icon-caret-down")} size="16" color="rgba(0, 0, 0, 0.60)"></${E("icon-caret-down")}>`}" 
            ?endicon="${!0}"
            ?disabled="${this.disabled}"
      ...
      ${this.toggleDropDown?p`
            <${S}
              exportparts="${K.UNORDERED_LIST}"
              style=${this.customWidth?`width: ${this.customWidth}px;`:$}
            ...
            >
              ${e.length>0?e.map(t=>this.getSelectedOption(t)):p`
                <${v}
                  part="${l.NO_LIST_ITEM}"
          ...
          `:$}
        ${this.showHelperText?p`<div part="${l.HELPER_TEXT}" aria-label="${this.helperText}">${this.helperText}</div>`:$}
    </div>
  `}};c([I()],o.prototype,"toggleDropDown",2);c([I()],o.prototype,"listItems",2);c([I()],o.prototype,"currentFocusedItem",2);c([I()],o.prototype,"inputValue",2);c([I()],o.prototype,"onInputHover",2);c([I()],o.prototype,"isInputFocused",2);c([I()],o.prototype,"isClearAllIconFocused",2);c([u({type:Boolean})],o.prototype,"disabled",2);c([u({type:Boolean})],o.prototype,"showHelperText",2);c([u({type:String})],o.prototype,"helperText",2);c([u({type:String})],o.prototype,"name",2);c([u({type:Array})],o.prototype,"selectedValues",2);c([u({type:Array})],o.prototype,"options",2);c([u({type:String})],o.prototype,"field",2);c([u({type:Boolean})],o.prototype,"showRemoveLabel",2);c([u({type:Boolean})],o.prototype,"emptyOptions",2);c([u({type:Boolean})],o.prototype,"clearIcon",2);c([u({type:String})],o.prototype,"customWidth",2);c([u({type:String})],o.prototype,"placeholder",2);c([u({type:String})],o.prototype,"label",2);o=c([G()],o);customElements.get(_)?le("Component (%s) is currently registered and not possible to registrate again.",_):customElements.define(_,o);const s=[{id:"apple",name:"Apple",value:"apple"},{id:"banana",name:"Banana",value:"banana"},{id:"cherry",name:"Cherry",value:"cherry"},{id:"date",name:"Date",value:"date"}],ie={title:"Input/Enchanted Multiple Select Chip",component:"enchanted-multiple-select-chip",tags:["a11y-addon"],decorators:[e=>p`
    <div 
    style="
    display: flex;
    ...
    min-height: 150px;">
      ...
      <${i}
        ...
        field="${e.field}"
      ></${i}>
    `},b={parameters:{controls:{disable:!0}},render:()=>p`
      <style>
        .select-container {
          display: flex;
    ...
    `};var P,A,O;C.parameters={...C.parameters,docs:{...(P=C.parameters)==null?void 0:P.docs,source:{originalSource:`{
  name: 'Default',
  render: args => {
    return html\`
...
}`,...(O=(A=C.parameters)==null?void 0:A.docs)==null?void 0:O.source}}};var w,x,H,F,V;b.parameters={...b.parameters,docs:{...(w=b.parameters)==null?void 0:w.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    }
...
Demonstrates various selection states, validation, helper text, and customization options.`,...(V=(F=b.parameters)==null?void 0:F.docs)==null?void 0:V.description}}};const ae=["EnchantedMultipleSelectChipStory","AllStates"],be=Object.freeze(Object.defineProperty({__proto__:null,AllStates:b,EnchantedMultipleSelectChipStory:C,__namedExportsOrder:ae,default:ie},Symbol.toStringTag,{value:"Module"}));export{be as E,C as a};
