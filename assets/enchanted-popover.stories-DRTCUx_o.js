import{E as h,x as p}from"./iframe-I2cpem8U.js";import{n as a,t as f,E as L,L as P}from"./enchanted-ac-base-element-CYtj5YlD.js";import"./index-Bz6YrIBk.js";import{g as E}from"./localization-D5pUJpuu.js";import{t as r}from"./cssClassEnums-WDBe4U61.js";import"./enchanted-button-bGeso_Ea.js";import"./preload-helper-C1FmrZbK.js";import"./index-CuTRIAwF.js";import"./index-ciz72CDE.js";import"./state-0u-7W5Ce.js";import"./keyboardEventKeys-BnoN8uA3.js";var R=Object.defineProperty,_=Object.getOwnPropertyDescriptor,n=(e,d,u,l)=>{for(var i=l>1?void 0:l?_(d,u):d,v=e.length-1,b;v>=0;v--)(b=e[v])&&(i=(l?b(d,u,i):b(i))||i);return l&&i&&R(d,u,i),i};let o=class extends L{constructor(){super(...arguments),this.open=!1,this.label="Label",this.text="Text",this.showLabel=!1,this.showText=!1,this.showCloseIcon=!1,this.inverse=!1,this.withpadding=!1,this.disableHover=!1,this._showPopover=()=>{this.disableHover||(this.open=!0)},this._hidePopover=()=>{this.disableHover||(this.open=!1)},this._onCloseClick=e=>{e.stopPropagation(),this.open=!1,this.dispatchEvent(new CustomEvent("enchanted-popover-closed",{bubbles:!0,composed:!0,detail:{reason:"click-icon-close"}}))}}get isLTR(){return E()===P.LTR}render(){return p`
...
- Label and text visibility combinations`,...(O=(y=s.parameters)==null?void 0:y.docs)==null?void 0:O.description}}};const V=["EnchantedPopoverStory","AllStates"];export{s as AllStates,c as EnchantedPopoverStory,V as __namedExportsOrder,G as default};
