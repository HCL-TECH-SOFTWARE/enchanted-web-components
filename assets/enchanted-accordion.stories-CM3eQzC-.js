import{x as t,E as u}from"./iframe-I2cpem8U.js";import{n as i,t as O,E as N,L as A}from"./enchanted-ac-base-element-CYtj5YlD.js";import{r as E}from"./state-0u-7W5Ce.js";import{l as b}from"./lodash-CN9U4Hn1.js";import{g as _}from"./localization-D5pUJpuu.js";import{A as o}from"./cssClassEnums-WDBe4U61.js";import{t as S}from"./index-CuTRIAwF.js";import{c as D,B as R}from"./index-ciz72CDE.js";import{K as x}from"./keyboardEventKeys-BnoN8uA3.js";import"./preload-helper-C1FmrZbK.js";var m={elem:"svg",attrs:{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 32 32",fill:"currentColor",width:32,height:32},content:[{elem:"path",attrs:{d:"M16 22L6 12 7.4 10.6 16 19.2 24.6 10.6 26 12z"}}],name:"chevron--down",size:32};const C="icon-chevron-down";class k extends R{render(){return t`${S({...m,attrs:{...m.attrs,preserveAspectRatio:"xMidYMid"}})}`}}D&&!customElements.get(C)&&customElements.define(C,k);var L=Object.defineProperty,I=Object.getOwnPropertyDescriptor,c=(e,n,h,r)=>{for(var d=r>1?void 0:r?I(n,h):n,p=e.length-1,y;p>=0;p--)(y=e[p])&&(d=(r?y(n,h,d):y(d))||d);return r&&d&&L(n,h,d),d};let a=class extends N{constructor(){super(...arguments),this.showCheckbox=!1,this.disabled=!1,this.showSecondaryText=!1,this.type="outlined",this.open=!1,this.label="",this.secondaryText="",this.isLTR=_()===A.LTR}toggleAccordion(){this.disabled||(this.open=!this.open)}handleKeyToggle(n){(n.key===x.ENTER||n.key===x.SPACE)&&(n.preventDefault(),this.toggleAccordion())}handleArrowClick(n){n.stopPropagation(),this.toggleAccordion()}render(){return t`
      <div
    ...
    `,parameters:{docs:{description:{story:"Showcase of all accordion states and variations including both types (outlined and no-outline), open/closed states, with checkboxes, secondary text, disabled state, and combined features. This demonstrates the complete range of accordion configurations available."}}}};var T,v,$;s.parameters={...s.parameters,docs:{...(T=s.parameters)==null?void 0:T.docs,source:{originalSource:`{
  render: args => {
    return html\`
      <enchanted-accordion
        type=\${args.type}
...
}`,...($=(v=s.parameters)==null?void 0:v.docs)==null?void 0:$.source}}};var w,f,g;l.parameters={...l.parameters,docs:{...(w=l.parameters)==null?void 0:w.docs,source:{originalSource:`{
  render: () => {
    return html\`
      <div style="display: flex; flex-direction: column; gap: 16px;">
        <div><strong>Outlined Type</strong></div>
...
}`,...(g=(f=l.parameters)==null?void 0:f.docs)==null?void 0:g.source}}};const q=["EnchantedAccordion","AllStates"];export{l as AllStates,s as EnchantedAccordion,q as __namedExportsOrder,X as default};
