import{E as D,x as l}from"./iframe-I2cpem8U.js";import{n as y,t as k,E as C}from"./enchanted-ac-base-element-CYtj5YlD.js";import{l as S}from"./lodash-CN9U4Hn1.js";import{y as s}from"./cssClassEnums-WDBe4U61.js";import{K as b}from"./keyboardEventKeys-BnoN8uA3.js";import"./preload-helper-C1FmrZbK.js";var E=Object.defineProperty,I=Object.getOwnPropertyDescriptor,p=(t,e,r,a)=>{for(var i=a>1?void 0:a?I(e,r):e,o=t.length-1,h;o>=0;o--)(h=t[o])&&(i=(a?h(e,r,i):h(i))||i);return a&&i&&E(e,r,i),i};let d=class extends C{constructor(){super(...arguments),this.isChecked=!1,this.isDisabled=!1}partAttributeDecider(t){let e=t;switch(t){case s.SWITCH_SLIDER:return this.isChecked?(e=s.SWITCH_SLIDER_CHECKED,this.isDisabled&&(e=s.SWITCH_SLIDER_CHECKED_DISABLED)):this.isDisabled&&(e=s.SWITCH_SLIDER_DISABLED),e;case s.SWITCH_LABEL:return this.isDisabled&&(e=s.SWITCH_LABEL_DISABLED),e;case s.SWITCH_INPUT:return e;default:return e}}handleSwitchToggle(t){t.stopPropagation(),this.isChecked=!this.isChecked;const e=new CustomEvent("change",{detail:{isChecked:this.isChecked}});this.dispatchEvent(e)}pressKeyHandler(t){const e=t;(e.key===b.ENTER||e.key==b.SPACE)&&(t.preventDefault(),this.handleSwitchToggle(t))}render(){return l`
    <label
