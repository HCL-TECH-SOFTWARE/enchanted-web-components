import{c as g,a2 as h,E as b,s as t,g as E,u as d,n as p,a3 as n}from"./tags-GuWqQq8Q.js";import"./enchanted-button-BAnGK4C4.js";import{P as e,s as l,i as y,k as x}from"./cssClassEnums-BAuKGcJP.js";import"./index-CTiHq96Y.js";import"./iframe-DIZdwA76.js";import"./preload-helper-C1FmrZbK.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./state-CtyNSLbf.js";import"./query-BApjzB0v.js";import"./localization-CViIwzVj.js";import"./keyboardEventKeys-BnoN8uA3.js";import"./index-CuTRIAwF.js";import"./tags-OypiFpf3.js";var D=Object.defineProperty,r=(i,m,T,H)=>{for(var o=void 0,v=i.length-1,A;v>=0;v--)(A=i[v])&&(o=A(m,T,o)||o);return o&&D(m,T,o),o};const O=g("enchanted-web-components:components:atomic-component:enchanted-panel.ts");class a extends b{constructor(){super(...arguments),this.open=!1,this.position=e.PANEL_LEFT,this.headerTitle="",this.ariaLabel="",this.focusPanel=!1}show(){this.open=!0}hide(){this.open=!1}_handleCloseClick(){this.hide(),this.dispatchEvent(new CustomEvent("enchantedPanelClose"))}render(){return d`
      <div
      ...
      >
        <div part=${l.PANEL_HEADER}>
          ...
          <${t}
            ...
            buttontext=""
            ?outlined="${!1}"
            .icon="${d`<${E("icon-close")} size="16" color="rgba(0, 0, 0, 0.60)"></${E("icon-close")}>`}"
    ...
    `}}r([p({type:Boolean,reflect:!0})],a.prototype,"open");r([p({type:String,reflect:!0})],a.prototype,"position");r([p({type:String})],a.prototype,"headerTitle");r([p({type:String})],a.prototype,"ariaLabel");r([p({type:Boolean})],a.prototype,"focusPanel");customElements.get(h)?O("Component (%s) is currently registered and not possible to registrate again.",h):customElements.define(h,a);const V={title:"Overlay/Enchanted Panel",tags:["autodocs","a11y-addon"],decorators:[i=>d`
    <div style="position: relative; min-height: 200px; width: 100%;">
      ${i()}
    </div>`],argTypes:{open:{control:{type:"boolean"},description:"Whether the panel is open",table:{category:"State",type:{summary:"boolean"},defaultValue:{summary:"false"}}},title:{control:{type:"text"},description:"Panel title",table:{category:"Content",type:{summary:"string"},defaultValue:{summary:""}}},position:{control:{type:"radio"},options:[e.PANEL_LEFT,e.PANEL_RIGHT],description:"Panel position",table:{type:{summary:"string"},defaultValue:{summary:e.PANEL_LEFT}}}},args:{open:!0,title:"Panel Title",position:e.PANEL_LEFT},render:i=>d`
      <${n}
        ?open=${i.open}
        title="${i.title}"
        position="${i.position}"
    ...
    `},c={},s={parameters:{controls:{disable:!0}},render:()=>d`
      <style>
        .panel-container {
          display: flex;
    ...
    `};var N,u,P;c.parameters={...c.parameters,docs:{...(N=c.parameters)==null?void 0:N.docs,source:{originalSource:"{}",...(P=(u=c.parameters)==null?void 0:u.docs)==null?void 0:P.source}}};var $,_,f,C,L;s.parameters={...s.parameters,docs:{...($=s.parameters)==null?void 0:$.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    }
...
Demonstrates different positions, open/closed states, with/without title, and various content scenarios.`,...(L=(C=s.parameters)==null?void 0:C.docs)==null?void 0:L.description}}};const W=["Default","AllStates"];export{s as AllStates,c as Default,W as __namedExportsOrder,V as default};
