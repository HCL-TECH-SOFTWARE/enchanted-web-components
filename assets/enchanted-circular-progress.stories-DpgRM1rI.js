import{x as y}from"./iframe-BY3ui3w0.js";import"./enchanted-circular-progress-BjoRhPMd.js";import"./preload-helper-C1FmrZbK.js";import"./enchanted-ac-base-element-CBHL5x_U.js";const $={title:"Feedback/enchanted-circular-progress",component:"enchanted-circular-progress",tags:["autodocs"],argTypes:{size:{control:{type:"number",min:20,max:200,step:1},description:"Size of the circular progress in pixels",defaultValue:40},strokewidth:{control:{type:"number",min:1,max:20,step:.1},description:"Stroke width of the progress circle in pixels",defaultValue:3.6},trackcolor:{control:{type:"color"},description:"Color of the track (background circle)",defaultValue:"#D6D6D6"},progresscolor:{control:{type:"color"},description:"Color of the progress indicator",defaultValue:"#0550DC"},disableShrink:{control:{type:"boolean"},description:"Disables the shrink animation for high CPU scenarios",defaultValue:!1}},args:{size:40,strokewidth:3.6,trackcolor:"#D6D6D6",progresscolor:"#0550DC",disableShrink:!1},parameters:{docs:{description:{component:"Enchanted Circular Progress component - Indeterminate variant. Displays an animated circular progress indicator with separate track and progress colors, inspired by Material UI CircularProgress. Features smooth rotation and dash animations. Use disable-shrink for high CPU load scenarios."}}}},o={render:s=>y`
    ...
    `},a={render:()=>{const s=["display: grid","grid-template-columns: repeat(4, 1fr)","gap: 48px","padding: 40px","min-height: 600px","justify-items: center","align-items: center"].join("; ")+";",r=["display: flex","flex-direction: column","align-items: center","gap: 16px","min-height: 140px"].join("; ")+";",e=["font-weight: 600","font-size: 14px","color: #333","text-align: center"].join("; ")+";",t=["grid-column: 1 / -1","font-weight: 700","font-size: 16px","color: #0550DC","margin-top: 20px","margin-bottom: -20px"].join("; ")+";";return y`
      <div style="${s}">
        ...
        <div style="${r}">
          <span style="${e}">Default Animation</span>
          <enchanted-circular-progress size="40" strokewidth="3.6" trackcolor="#D6D6D6" progresscolor="#0550DC"></enchanted-circular-progress>
        </div>
        <div style="${r}">
          <span style="${e}">Disable Shrink</span>
        ...
        <div style="${r}">
          <span style="${e}">Large + Disable Shrink</span>
        ...
        <div style="${r}">
          <span style="${e}">Minimum Size (20px)</span>
          <enchanted-circular-progress size="20" strokewidth="2" trackcolor="#D6D6D6" progresscolor="#0550DC"></enchanted-circular-progress>
        </div>
        <div style="${r}">
          <span style="${e}">Maximum Stroke<br/>(Half Radius)</span>
          <enchanted-circular-progress size="60" strokewidth="20" trackcolor="#D6D6D6" progresscolor="#0550DC"></enchanted-circular-progress>
        </div>
        <div style="${r}">
          <span style="${e}">Transparent Track</span>
        ...
        <div style="${r}">
          <span style="${e}">Semi-transparent</span>
...
**Edge Cases**: Minimum size, maximum stroke width, transparent track, and semi-transparent colors.`}},controls:{disable:!0}}};var i,n,c,l,p;o.parameters={...o.parameters,docs:{...(i=o.parameters)==null?void 0:i.docs,source:{originalSource:`{
  render: args => {
    return html\`
      <enchanted-circular-progress
        .size=\${args.size}
...
}`,...(c=(n=o.parameters)==null?void 0:n.docs)==null?void 0:c.source},description:{story:`Interactive enchanted circular progress component with controls for size, colors, and shrink animation.
...
- Toggle the shrink animation for performance optimization`,...(p=(l=o.parameters)==null?void 0:l.docs)==null?void 0:p.description}}};var d,h,g;a.parameters={...a.parameters,docs:{...(d=a.parameters)==null?void 0:d.docs,source:{originalSource:`{
  render: () => {
...
}`,...(g=(h=a.parameters)==null?void 0:h.docs)==null?void 0:g.source}}};const v=["Default","AllStates"];export{a as AllStates,o as Default,v as __namedExportsOrder,$ as default};
