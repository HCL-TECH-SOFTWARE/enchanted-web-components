import{x as s,E as _}from"./iframe-DHDpWj8R.js";import{n as m,t as K,E as j}from"./enchanted-ac-base-element-DiERHT3A.js";import{r as E}from"./state-CAzxSWuk.js";import"./enchanted-circular-progress-DHQJc59E.js";import"./enchanted-icon-button-D07MISMY.js";import"./enchanted-select-CPbUZhZI.js";import{I as c}from"./enchanted-item-type-avatar-Cf1yxHOJ.js";import"./enchanted-tooltip-CyfaM-R4.js";import{q as r,I as T,g as J,i as Q,T as I}from"./cssClassEnums-D4dgqifY.js";import{a as ee,T as v,I as y,P as te,b as S,c as $,d as ie}from"./exportParts-lw5uKHST.js";import{i as ne}from"./localization-Dlp2bMpu.js";import"./index-CWdDvK9Q.js";import"./index-B6tA5DEv.js";import{c as f,B as b,t as A}from"./index-BdjfDspd.js";import{K as oe}from"./keyboardEventKeys-BnoN8uA3.js";import"./preload-helper-C1FmrZbK.js";import"./enchanted-button-CLWRKz3u.js";import"./lodash-CoWAiiJq.js";import"./enchanted-list-item-vzhnM9Xg.js";import"./enchanted-select-Ge91KUgI.js";import"./index-D5GA8BzZ.js";import"./enchanted-avatar-CS0Brxsm.js";import"./index-CjYVgHr4.js";const re=[10,25,50,75,100,175,250,325,400];var h=(e=>(e.CONTENT="Content",e.CONTENT_TEMPLATE="ContentTemplate",e.SITE_AREA_TEMPLATE="SiteAreaTemplate",e.LIBRARY_AUTHORING_TOOLS_COMPONENT="LibraryAuthoringToolsComponent",e.LIBRARY_DATE_COMPONENT="LibraryDateComponent",e.LIBRARY_FILE_COMPONENT="LibraryFileComponent",e.LIBRARY_HTML_COMPONENT="LibraryHTMLComponent",e.LIBRARY_IMAGE_COMPONENT="LibraryImageComponent",e.LIBRARY_JSP_COMPONENT="LibraryJSPComponent",e.LIBRARY_LINK_COMPONENT="LibraryLinkComponent",e.LIBRARY_LIST_PRESENTATION_COMPONENT="LibraryListPresentationComponent",e.LIBRARY_MENU_COMPONENT="LibraryMenuComponent",e.LIBRARY_NAVIGATOR_COMPONENT="LibraryNavigatorComponent",e.LIBRARY_NUMERIC_COMPONENT="LibraryNumericComponent",e.OPTION_SELECTION_COMPONENT="OptionSelectionComponent",e.LIBRARY_PAGE_NAVIGATION_COMPONENT="LibraryPageNavigationComponent",e.LIBRARY_PERSONALIZATION_COMPONENT="LibraryPersonalizationComponent",e.LIBRARY_REFERENCE_COMPONENT="LibraryReferenceComponent",e.LIBRARY_RICH_TEXT_COMPONENT="LibraryRichTextComponent",e.LIBRARY_SEARCH_COMPONENT="LibrarySearchComponent",e.LIBRARY_SHORT_TEXT_COMPONENT="LibraryShortTextComponent",e.LIBRARY_STYLESHEET_COMPONENT="LibraryStyleSheetComponent",e.LIBRARY_TAXONOMY_COMPONENT="LibraryTaxonomyComponent",e.LIBRARY_TEXT_COMPONENT="LibraryTextComponent",e.LIBRARY_USER_NAME_COMPONENT="LibraryUserNameComponent",e.LIBRARY_USER_SELECTION_COMPONENT="LibraryUserSelectionComponent",e.CATEGORY="Category",e.CONTENT_LINK="ContentLink",e.FOLDER="Folder",e.LIBRARY="Library",e.PORTAL_PAGE="PortalPage",e.PRESENTATION_TEMPLATE="PresentationTemplate",e.PROJECT="Project",e.PROJECT_TEMPLATE="ProjectTemplate",e.SEGMENT="Segment",e.SITE_AREA="SiteArea",e.TAXONOMY="Taxonomy",e.VERSION_ACTION="VersionAction",e.CUSTOM_WORKFLOW_ACTION="CustomWorkflowAction",e.EMAIL_ACTION="EmailAction",e.EXPIRE_ACTION="ExpireAction",e.PUBLISH_ACTION="PublishAction",e.SCHEDULED_MOVE_ACTION="ScheduledMoveAction",e.WORKFLOW="Workflow",e.WORKFLOW_STAGE="WorkflowStage",e.NOTEBOOK_REFERENCE="notebookReference",e.MAIL_ALL="mailAll",e.USER_PROFILE_ALT="userProfileAlt",e.LICENSE_GLOBAL="licenseGlobal",e.USER_PROFILE="userProfile",e.DATA_ANALYTICS="dataAnalytics",e.REMINDER="reminder",e.LICENSE_DRAFT="licenseDraft",e.EVENT_WARNING="eventWarning",e.LAYERS_EXTERNAL="layersExternal",e.SUBFLOW="subflow",e.DAM_COLLECTION="collection",e.DAM_IMAGE="image",e.DAM_VIDEO="video",e.DAM_DOCUMENT="application/vnd.openxmlformats-officedocument.wordprocessingml.document",e.DAM_XLS="application/vnd.ms-excel",e.DAM_XLSX="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",e.DAM_PPT="application/vnd.ms-powerpoint",e.DAM_PPTX="application/vnd.openxmlformats-officedocument.presentationml.presentation",e.DAM_PDF="application/pdf",e.DAM_GIF="image/gif",e.DAM_JPEG="image/jpeg",e.DAM_PNG="image/png",e.DAM_TIF="image/tiff",e.DAM_WEBP="image/webp",e.DAM_MP4="video/mp4",e.DAM_OGG="video/ogg",e.DAM_WEBM="video/webm",e))(h||{});const se={image:c.IMAGE,"image/jpeg":c.IMAGE,"image/png":c.IMAGE,"image/webp":c.IMAGE,video:c.VIDEO,"video/mp4":c.VIDEO,"video/ogg":c.VIDEO,"video/webm":c.VIDEO,"application/vnd.openxmlformats-officedocument.wordprocessingml.document":c.DOC,"application/pdf":c.PDF,"application/vnd.ms-excel":c.XLS,"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet":c.XLSX,"application/vnd.ms-powerpoint":c.PPT,"application/vnd.openxmlformats-officedocument.presentationml.presentation":c.PPTX,"image/tiff":c.TIF,"image/gif":c.GIF};var u=(e=>(e.SUCCESS="SUCCESS",e.ERROR_NOT_FOUND="ERROR_NOT_FOUND",e.ERROR_FORBIDDEN="ERROR_FORBIDDEN",e.ERROR_BAD_REQUEST="ERROR_BAD_REQUEST",e.ERROR_SERVER="ERROR_SERVER",e.ERROR_FORMAT_UNSUPPORTED="ERROR_FORMAT_UNSUPPORTED",e))(u||{});const ae=async e=>{if(!e)return u.ERROR_BAD_REQUEST;const t=new AbortController,i=t.signal;try{const n=await fetch(e,{method:"GET",credentials:"include",cache:"no-cache",signal:i});return n.ok?(t.abort(),u.SUCCESS):n.status===404?u.ERROR_NOT_FOUND:n.status===403?u.ERROR_FORBIDDEN:n.status>=500?u.ERROR_SERVER:u.ERROR_BAD_REQUEST}catch(n){return n instanceof Error&&n.name==="AbortError"?u.SUCCESS:u.ERROR_SERVER}};var x={elem:"svg",attrs:{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 32 32",fill:"currentColor",width:32,height:32},content:[{elem:"path",attrs:{d:"M8 12H18V14H8z"}},{elem:"path",attrs:{d:"M21.4479,20A10.856,10.856,0,0,0,24,13,11,11,0,1,0,13,24a10.856,10.856,0,0,0,7-2.5521L27.5859,29,29,27.5859ZM13,22a9,9,0,1,1,9-9A9.01,9.01,0,0,1,13,22Z"}}],name:"zoom--out",size:32};const B="icon-zoom-out";let le=class extends b{render(){return s`${A({...x,attrs:{...x.attrs,preserveAspectRatio:"xMidYMid"}})}`}};f&&!customElements.get(B)&&customElements.define(B,le);var U={elem:"svg",attrs:{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 32 32",fill:"currentColor",width:32,height:32},content:[{elem:"path",attrs:{d:"M18 12L14 12 14 8 12 8 12 12 8 12 8 14 12 14 12 18 14 18 14 14 18 14 18 12z"}},{elem:"path",attrs:{d:"M21.4479,20A10.856,10.856,0,0,0,24,13,11,11,0,1,0,13,24a10.856,10.856,0,0,0,7-2.5521L27.5859,29,29,27.5859ZM13,22a9,9,0,1,1,9-9A9.01,9.01,0,0,1,13,22Z"}}],name:"zoom--in",size:32};const V="icon-zoom-in";let de=class extends b{render(){return s`${A({...U,attrs:{...U.attrs,preserveAspectRatio:"xMidYMid"}})}`}};f&&!customElements.get(V)&&customElements.define(V,de);var z={elem:"svg",attrs:{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 32 32",fill:"currentColor",width:32,height:32},content:[{elem:"path",attrs:{d:"M26 24v4H6V24H4v4H4a2 2 0 002 2H26a2 2 0 002-2h0V24zM26 14L24.59 12.59 17 20.17 17 2 15 2 15 20.17 7.41 12.59 6 14 16 24 26 14z"}}],name:"download",size:32};const W="icon-download";let ce=class extends b{render(){return s`${A({...z,attrs:{...z.attrs,preserveAspectRatio:"xMidYMid"}})}`}};f&&!customElements.get(W)&&customElements.define(W,ce);var k={elem:"svg",attrs:{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 32 32",fill:"currentColor",width:32,height:32},content:[{elem:"path",attrs:{d:"M14 26L15.41 24.59 7.83 17 28 17 28 15 7.83 15 15.41 7.41 14 6 4 16 14 26z"}}],name:"arrow--left",size:32};const F="icon-arrow-left";let he=class extends b{render(){return s`${A({...k,attrs:{...k.attrs,preserveAspectRatio:"xMidYMid"}})}`}};f&&!customElements.get(F)&&customElements.define(F,he);var H={elem:"svg",attrs:{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 32 32",fill:"currentColor",width:32,height:32},content:[{elem:"path",attrs:{d:"M18 6L16.57 7.393 24.15 15 4 15 4 17 24.15 17 16.57 24.573 18 26 28 16 18 6z"}}],name:"arrow--right",size:32};const G="icon-arrow-right";class pe extends b{render(){return s`${A({...H,attrs:{...H.attrs,preserveAspectRatio:"xMidYMid"}})}`}}f&&!customElements.get(G)&&customElements.define(G,pe);var ue=Object.defineProperty,me=Object.getOwnPropertyDescriptor,l=(e,t,i,n)=>{for(var o=n>1?void 0:n?me(t,i):t,d=e.length-1,p;d>=0;d--)(p=e[d])&&(o=(n?p(t,i,o):p(o))||o);return n&&o&&ue(t,i,o),o};let a=class extends j{constructor(){super(...arguments),this._ZOOM_OPTIONS=re,this._ZOOM_BUTTON_MARGIN=12,this._ZOOM_DEFAULT=100,this.open=!1,this.items=[],this.customHeaderTitle=null,this.component="",this.renditionLabel="",this.selectButtonTitle="",this.currentItemIndex=0,this.selectedRenditionId=null,this.skipSourceValidation=!1,this.zoomPercentage=this._ZOOM_DEFAULT,this.zoomOutDisable=!1,this.zoomInDisable=!1,this.zoomToFitPercentage=this._ZOOM_DEFAULT,this.currentDisplaySource=null,this.isLoading=!0,this.hasError=!1,this.errorType=null,this.isMediaReady=!1,this.isZoomedIn=!1,this._activeRequestToken=0,this.isLtr=ne(),this._handleResize=()=>{var n,o;const e=this.items[this.currentItemIndex];if(!this.open||!e||e.type.split("/")[0]!==h.DAM_VIDEO)return;const t=(n=this.renderRoot)==null?void 0:n.querySelector('video[part="preview-item-video"]'),i=(o=this.renderRoot)==null?void 0:o.querySelector('div[part="preview-item-container"]');if(t&&i){if(!this.currentDisplaySource){t.removeAttribute("style");return}const d=t.videoWidth??0,O=(t.videoHeight??0)/d,R=i.offsetWidth,g=R*O;g<i.clientHeight?(t.style.width=`${R}px`,t.style.height=`${g}px`):(t.style.setProperty("height",`${i.clientHeight}px`,"important"),t.style.width="100%")}},this._handleKeydown=e=>{this.open&&e.key===oe.TAB&&this._handleTrapFocus(e)}}willUpdate(e){if(this.open&&(e.has("currentItemIndex")||e.has("items")||e.has("selectedRenditionId"))&&this._updateCurrentItemAndRendition(),e.has("zoomPercentage")||e.has("items")||e.has("currentItemIndex")){const t=this.items[this.currentItemIndex??0],i=(t==null?void 0:t.type.split("/")[0])===h.DAM_IMAGE;this.isZoomedIn=i&&this.zoomPercentage>100}this.isZoomedIn?this.classList.add("zoomed"):this.classList.remove("zoomed"),e.has("zoomPercentage")&&(this.style.setProperty("--zoom-scale-factor",`${this.zoomPercentage/100}`),this._updateImageDimensions()),e.has("isMediaReady")&&this.style.setProperty("--media-visibility",this.isMediaReady?"visible":"hidden")}_updateImageDimensions(){requestAnimationFrame(()=>{var i,n;const e=(i=this.renderRoot)==null?void 0:i.querySelector("#preview-item-image-wrapper"),t=(n=this.renderRoot)==null?void 0:n.querySelector("#preview-item-image");if(e&&t&&t.naturalWidth&&t.naturalHeight){const o=this.zoomPercentage/100,d=t.naturalWidth*o,p=t.naturalHeight*o;t.style.width=`${d}px`,t.style.height=`${p}px`,e.style.width=`${d}px`,e.style.height=`${p}px`,t.style.transform="",t.style.transformOrigin=""}})}updated(e){var t;super.updated(e),e.has("open")&&this.open&&requestAnimationFrame(()=>{var n;const i=(n=this.renderRoot)==null?void 0:n.querySelector('[role="dialog"]');i&&i.focus()}),this.open&&((t=this.items[this.currentItemIndex])==null?void 0:t.type.split("/")[0])===h.DAM_VIDEO&&(e.has("open")||e.has("currentItemIndex")||e.has("items"))&&requestAnimationFrame(()=>{this._handleResize()})}async _updateCurrentItemAndRendition(){this._activeRequestToken++;const e=this._activeRequestToken;if(this.isLoading=!0,this.isMediaReady=!1,this.hasError=!1,this.errorType=null,this.currentDisplaySource=null,this.items.length===0||this.currentItemIndex<0||this.currentItemIndex>=this.items.length){e===this._activeRequestToken&&(this.isLoading=!1);return}const t=this.items[this.currentItemIndex],i=t.type.split("/")[0];if((i===h.DAM_IMAGE||i===h.DAM_VIDEO)&&t.renditions&&t.renditions.length>0){let n=t.renditions.find(o=>o.id===this.selectedRenditionId);if(n||(n=t.renditions[0]),this.selectedRenditionId=n.id,this.skipSourceValidation){e===this._activeRequestToken&&(this.currentDisplaySource=n.source,this.isLoading=!1);return}try{const o=await ae(n.source);if(e!==this._activeRequestToken)return;o===u.SUCCESS?this.currentDisplaySource=n.source:(this.hasError=!0,this.errorType=o,this.dispatchEvent(new CustomEvent("preview-error",{detail:{item:t,errorType:this.errorType},bubbles:!0,composed:!0})))}finally{e===this._activeRequestToken&&(this.isLoading=!1)}}else e===this._activeRequestToken&&(this.isLoading=!1,this.hasError=!0)}_resetState(){this.open=!1,this.isLoading=!0,this.hasError=!1,this.isMediaReady=!1,this.errorType=null,this.selectedRenditionId=null,this.currentDisplaySource=null,this.zoomPercentage=this._ZOOM_DEFAULT,this._activeRequestToken=0}_handleBack(){this._resetState(),this.dispatchEvent(new CustomEvent("preview-back",{detail:{open:this.open},bubbles:!0,composed:!0}))}_handlePreviousButtonClick(){const e=new CustomEvent("preview-previous",{bubbles:!0,composed:!0,detail:{previousIndex:this.currentItemIndex-1},cancelable:!0});this.dispatchEvent(e),e.defaultPrevented||(this.currentItemIndex-=1)}_handleNextButtonClick(){const e=new CustomEvent("preview-next",{bubbles:!0,composed:!0,detail:{nextIndex:this.currentItemIndex+1},cancelable:!0});this.dispatchEvent(e),e.defaultPrevented||(this.currentItemIndex+=1)}_handleZoomOutButtonClick(){const t=[...this._ZOOM_OPTIONS].reverse().find(i=>this.zoomPercentage>i);t===10&&(this.zoomOutDisable=!0),t&&(this.zoomPercentage=t),this.zoomInDisable=!1}_handleZoomInButtonClick(){const e=this._ZOOM_OPTIONS.find(t=>t>this.zoomPercentage);e===400&&(this.zoomInDisable=!0),e&&(this.zoomPercentage=e),this.zoomOutDisable=!1}_calculateImagePercentage(){var O;const e=(O=this.renderRoot)==null?void 0:O.querySelector("#preview-item-image"),t=(e==null?void 0:e.height)??0,i=e.clientHeight??0;if(t===i){const R=Math.round((i-this._ZOOM_BUTTON_MARGIN*2)/i*100);return this.zoomToFitPercentage=R,R}const n=Math.round((i-this._ZOOM_BUTTON_MARGIN*2)/t*100),o=e.clientWidth??0,d=e.width??0,p=Math.round((o-this._ZOOM_BUTTON_MARGIN*2)/d*100);return this.zoomToFitPercentage=Math.min(n,p),this._ZOOM_DEFAULT}_handleZoomPercentageFitClick(){this.zoomPercentage!==this._ZOOM_DEFAULT?this.zoomPercentage=this._ZOOM_DEFAULT:this.zoomPercentage=this.zoomToFitPercentage,this.zoomInDisable=!1,this.zoomOutDisable=!1}_handlePreviewError(){this.isLoading=!1,this.hasError=!0,this.isMediaReady=!1,this.errorType=u.ERROR_FORMAT_UNSUPPORTED;const e=this.items[this.currentItemIndex];this.dispatchEvent(new CustomEvent("preview-error",{detail:{item:e,errorType:this.errorType},bubbles:!0,composed:!0}))}getUnsupportedFileComponent(e,t=""){return s`
    ...
    `}_renderPreviewItem(){if(this.component)return s`
      ...
      `;if(!this.items||this.items.length===0)return _;if(this.hasError){const i=this.items[this.currentItemIndex];return this.getUnsupportedFileComponent(i==null?void 0:i.type,i==null?void 0:i.fileExtension)}if(this.isLoading)return _;const e=this.items[this.currentItemIndex];if(!this.currentDisplaySource)return this.getUnsupportedFileComponent(e==null?void 0:e.type,e==null?void 0:e.fileExtension);switch(e.type.split("/")[0]){case h.DAM_IMAGE:return s`
        ...
        `;default:return this.getUnsupportedFileComponent(e.type,e==null?void 0:e.fileExtension)}}_getRenditionOptionValue(e){return e.type?`${e.type} (${e.dimension??this.getMessage("preview.rendition.metadata.unknown")})`:""}_getDefaultSelectedRenditionValue(){if(this.currentItemIndex===null||this.currentItemIndex<0||this.currentItemIndex>=this.items.length)return"";const e=this.items[this.currentItemIndex];if(e&&e.type.split("/")[0]===h.DAM_IMAGE&&e.renditions&&e.renditions.length>0){const t=e.renditions.find(i=>i.id===this.selectedRenditionId);if(t)return this._getRenditionOptionValue(t);if(e.renditions.length>0)return this._getRenditionOptionValue(e.renditions[0])}return""}_handleRenditionSelectChange(e){var n;const t=(n=e.detail)==null?void 0:n.value;if(t===void 0||this.currentItemIndex===null)return;const i=this.items[this.currentItemIndex];if(i&&i.type.split("/")[0]===h.DAM_IMAGE&&i.renditions){const o=i.renditions.find(d=>d.id===t);if(o){const d=new CustomEvent("preview-rendition-change",{bubbles:!0,composed:!0,detail:{id:this.items[this.currentItemIndex].id,title:this.items[this.currentItemIndex].title,selectedRenditionId:o.id,source:this.currentDisplaySource},cancelable:!0});this.dispatchEvent(d),d.defaultPrevented||(this.selectedRenditionId=o.id)}}}_handleMediaReady(){this.isLoading=!1,this.isMediaReady=!0,this.hasError=!1;const e=this.items[this.currentItemIndex];if(!e)return;const t=e.type.split("/")[0];t===h.DAM_IMAGE?requestAnimationFrame(()=>{this.zoomPercentage=this._calculateImagePercentage(),this._updateImageDimensions()}):t===h.DAM_VIDEO&&requestAnimationFrame(()=>this._handleResize())}_handleDownloadButtonClick(){this.dispatchEvent(new CustomEvent("preview-download",{bubbles:!0,composed:!0,detail:{id:this.items[this.currentItemIndex].id,title:this.items[this.currentItemIndex].title,selectedRenditionId:this.selectedRenditionId,source:this.currentDisplaySource}}))}_handleSelectButtonClick(){this.dispatchEvent(new CustomEvent("preview-select",{bubbles:!0,composed:!0,detail:{id:this.items[this.currentItemIndex].id,title:this.items[this.currentItemIndex].title,selectedRenditionId:this.selectedRenditionId,source:this.currentDisplaySource}}))}_handleTrapFocus(e){var d;const t=(d=this.renderRoot)==null?void 0:d.querySelectorAll("enchanted-icon-button:not([disabled]), enchanted-button:not([disabled]), enchanted-select:not([disabled])"),i=t==null?void 0:t[0],n=t==null?void 0:t[t.length-1],o=this.renderRoot&&this.renderRoot.activeElement;e.shiftKey?o===i&&(n==null||n._focusButton(),e.preventDefault()):o===n&&(i==null||i._focusButton(),e.preventDefault())}connectedCallback(){super.connectedCallback(),window.addEventListener("resize",this._handleResize),window.addEventListener("keydown",this._handleKeydown),this.renditionLabel==""&&(this.renditionLabel=this.getMessage("preview.rendition.label")),this.selectButtonTitle==""&&(this.selectButtonTitle=this.getMessage("select"))}disconnectedCallback(){window.removeEventListener("resize",this._handleResize),window.removeEventListener("keydown",this._handleKeydown),super.disconnectedCallback()}render(){var w,L,D;const e=this.isLoading||this.currentDisplaySource&&!this.isMediaReady&&!this.hasError||(this.isPreviousButtonDisabled!==void 0?this.isPreviousButtonDisabled:this.currentItemIndex<=0),t=this.isLoading||this.currentDisplaySource&&!this.isMediaReady&&!this.hasError||(this.isNextButtonDisabled!==void 0?this.isNextButtonDisabled:this.currentItemIndex===this.items.length-1),i=this.items[this.currentItemIndex??0],n=(i==null?void 0:i.type.split("/")[0])===h.DAM_IMAGE,o=i==null?void 0:i.renditions;if(!this.open)return _;const d=this.getMessage("preview.tooltip.download.button"),p=this.getMessage("preview.tooltip.next.asset.button"),O=this.getMessage("preview.tooltip.previous.asset.button"),R=this.getMessage("preview.tooltip.zoom.out.button"),g=this.getMessage("preview.tooltip.zoom.in.button"),P=this.getMessage(this.zoomPercentage===100?"preview.tooltip.zoom.to.fit":"preview.tooltip.view.actual.size"),C=this.customHeaderTitle??((w=this.items[this.currentItemIndex])==null?void 0:w.title)??this.getMessage("preview.header.title");return s`
      ...
      <div part=${r.PREVIEW_CONTAINER} role="dialog" aria-modal="true" tabindex="-1" aria-label=${C} aria-modal="true">
        <div part=${r.PREVIEW_HEADER} data-testid="enchanted-preview-header">
          <div part=${r.PREVIEW_HEADER_START_ACTIONS}>
            <enchanted-tooltip tooltiptext=${this.getMessage("preview.tooltip.back.button")} exportparts=${v}>
          ...
          <div part=${r.PREVIEW_HEADER_END_ACTIONS}>
            ${this.items.length>0?s`
                <enchanted-tooltip tooltiptext=${d} exportparts=${v}>
                  <enchanted-icon-button
                    slot="target"
...
}`,...(q=(X=N.parameters)==null?void 0:X.docs)==null?void 0:q.source}}};const He=["EnchantedPreviewStory"];export{N as EnchantedPreviewStory,He as __namedExportsOrder,Fe as default};
