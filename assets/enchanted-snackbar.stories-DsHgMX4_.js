import{x as n}from"./iframe-8woUqRZQ.js";import{n as R,t as S,E as N}from"./enchanted-ac-base-element-B2r6Mb3d.js";import"./enchanted-circular-progress-5u_Caxkh.js";import{S as e,w as t}from"./cssClassEnums-WDBe4U61.js";import"./index-CJt4sLmi.js";import"./index-CR1bBDvv.js";import"./enchanted-button-DuogflDy.js";import"./preload-helper-C1FmrZbK.js";import"./index-CuTRIAwF.js";import"./index-CrPUyF-a.js";import"./state-CWv-Gofn.js";import"./localization-D1j1HXL7.js";import"./keyboardEventKeys-BnoN8uA3.js";var k=Object.defineProperty,C=Object.getOwnPropertyDescriptor,h=(s,i,p,r)=>{for(var a=r>1?void 0:r?C(i,p):i,m=s.length-1,l;m>=0;m--)(l=s[m])&&(a=(r?l(i,p,a):l(a))||a);return r&&a&&k(i,p,a),a};let d=class extends N{constructor(){super(...arguments),this.message="",this.type=e.SNACKBAR_INFO}_renderPreElement(){if(e.SNACKBAR_PROGRESS==this.type)return n`
          <div part="${t.SNACKBAR_PROGRESS}">
        ...
        `;switch(this.type){case e.SNACKBAR_INFO:return n`<icon-information size="16" data-test-id="enchanted-snackbar-icon" part="${t.SNACKBAR_ICON} icon-${this.type}"></icon-information>`;case e.SNACKBAR_WARNING:return n`<icon-warning-alt size="16" data-test-id="enchanted-snackbar-icon" part="${t.SNACKBAR_ICON} icon-${this.type}"></icon-warning-alt>`;case e.SNACKBAR_ERROR:return n`<icon-warning size="16" data-test-id="enchanted-snackbar-icon" part="${t.SNACKBAR_ICON} icon-${this.type}"></icon-warning>`;case e.SNACKBAR_SUCCESS:return n`<icon-checkmark-outline size="16" part="${t.SNACKBAR_ICON} icon-${this.type}"></icon-checkmark-outline>`}}render(){return n`
        <div part=${t.SNACKBAR_CONTAINER}>
          <div part=${t.SNACKBAR_ICON_CONTAINER}>${this._renderPreElement()}</div>
          <span
            data-testid="enchanted-snackbar-message"
            part=${t.SNACKBAR_MESSAGE}
            .innerHTML=${this.message}
          ></span>
          <div part=${t.SNACKBAR_BUTTON_CONTAINER}>
            <div part=${t.SNACKBAR_BUTTONS}><slot name="snackbar-buttons"></slot></div>
          </div>
        </div>
      `}};h([R({type:String})],d.prototype,"message",2);h([R({type:String})],d.prototype,"type",2);d=h([S("enchanted-snackbar")],d);const M={title:"Feedback/enchanted-snackbar",tags:["autodocs"],parameters:{docs:{description:{component:"The Snackbar component displays brief, temporary messages or notifications at the bottom of the screen. It supports five visual types (info, success, warning, error, progress) with corresponding icons, accepts HTML content in messages, and can include action buttons via slots. Use snackbars for non-critical feedback that doesn't require immediate user action."}}},argTypes:{message:{control:{type:"text"},description:"Message text displayed in the snackbar. Supports HTML formatting including bold text, line breaks, and other inline elements for rich content display.",table:{category:"Content",type:{summary:"string"},defaultValue:{summary:""}}},type:{control:{type:"select"},options:[e.SNACKBAR_INFO,e.SNACKBAR_SUCCESS,e.SNACKBAR_WARNING,e.SNACKBAR_ERROR,e.SNACKBAR_PROGRESS],description:"Visual type of the snackbar. Determines the icon and color scheme: info (information), success (checkmark), warning (alert), error (warning), or progress (circular spinner).",table:{category:"Display",type:{summary:"SNACKBAR_TYPE"},defaultValue:{summary:e.SNACKBAR_INFO}}}},args:{message:"Sample snackbar message",type:e.SNACKBAR_INFO},render:s=>n`
      <enchanted-snackbar
        message="${s.message}"
        .type="${s.type}"
      >
...
}`,...(y=(u=c.parameters)==null?void 0:u.docs)==null?void 0:y.source}}};const W=["Default","AllStates"];export{c as AllStates,o as Default,W as __namedExportsOrder,M as default};
