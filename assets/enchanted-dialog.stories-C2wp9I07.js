import{c as L,K as S,h as k,l as w,n as g,Z as T,a as G,u as p,g as y,y as I,_ as n}from"./tags-BoxFtPAv.js";import{E as v}from"./iframe-CXiC-zJe.js";import{l as E}from"./lodash-CdDiHlzQ.js";import"./enchanted-svg-icon-CMfNf8aH.js";import"./enchanted-button-ClBT8-Pl.js";import{h as t,i as b}from"./cssClassEnums-CY7zIYSt.js";import{i as C}from"./localization-YUdjb7F_.js";import{K as $}from"./keyboardEventKeys-BnoN8uA3.js";import"./index-CZiPudfq.js";var e=(i=>(i.XL="xl",i.LG="lg",i.MD="md",i.SM="sm",i.XS="xs",i.CHAT="chat",i))(e||{}),B=Object.defineProperty,R=Object.getOwnPropertyDescriptor,u=(i,o,d,a)=>{for(var l=a>1?void 0:a?R(o,d):o,c=i.length-1,s;c>=0;c--)(s=i[c])&&(l=(a?s(o,d,l):s(l))||l);return a&&l&&B(o,d,l),l};const M=L("enchanted-web-components:components:atomic-component:enchanted-dialog.ts");let r=class extends G{constructor(){super(...arguments),this.open=!1,this.size=e.XL,this.dialogTitle="",this.overrideTitle=!1,this.removeBorder=!1,this.disableBackdropClick=!1,this._debounceBackdropClick=E.debounce(o=>{this.handleBackdropClick(o)},300)}connectedCallback(){super.connectedCallback(),this.dialogTitle===""&&(this.dialogTitle=this.getMessage("generic.label"))}disconnectedCallback(){super.disconnectedCallback()}async updated(o){o.has("open")&&this.open&&(await this.updateComplete,this._focusFirstElement())}_focusFirstElement(){const o=this.renderRoot.querySelectorAll("slot");for(const l of Array.from(o)){const c=l.assignedElements({flatten:!0});for(const s of c){if(s.matches(r.FOCUSABLE_SELECTOR)){this._focusElement(s);return}const f=s.querySelector(r.FOCUSABLE_SELECTOR);if(f){this._focusElement(f);return}}}const d=this.renderRoot.querySelector(r.FOCUSABLE_SELECTOR);if(d){this._focusElement(d);return}const a=this.renderRoot.querySelector(`[part*="${this.getPaperPart()}"]`);a==null||a.focus()}_hasShadowRoot(o){return"shadowRoot"in o&&o.shadowRoot instanceof ShadowRoot}_hasRenderRoot(o){return"renderRoot"in o&&o.renderRoot instanceof ShadowRoot}_focusElement(o,d=0){if(d>=r.MAX_FOCUS_DEPTH){o.focus();return}let a=o,l=null,c=d;for(;a&&c<r.MAX_FOCUS_DEPTH;){if(this._hasShadowRoot(a)){const s=a.shadowRoot.querySelector(r.FOCUSABLE_SELECTOR);if(s){a=s,l=s,c++;continue}}else if(this._hasRenderRoot(a)){const s=a.renderRoot.querySelector(r.FOCUSABLE_SELECTOR);if(s){a=s,l=s,c++;continue}}break}(l||o).focus()}async refocusDialog(){this.open&&(await this.updateComplete,this._focusFirstElement())}handleClose(o){o.stopPropagation(),this.open=!1,this.dispatchEvent(new CustomEvent("enchanted-dialog-close",{bubbles:!0,composed:!0}))}handleBackdropClick(o){if(this.disableBackdropClick){o.stopPropagation();return}this.handleClose(o)}handleCloseByEnterKey(o){(o.key===$.ENTER||o.key===$.SPACE)&&(o.stopPropagation(),this.handleClose(o))}getContainerPart(){switch(this.size){case e.XL:return t.CONTAINER_XL;case e.XS:return t.CONTAINER_XS;case e.SM:return t.CONTAINER_SM;case e.MD:return t.CONTAINER_MD;case e.LG:return t.CONTAINER_LG;case e.CHAT:return t.CONTAINER_CHAT;default:return t.CONTAINER_XL}}getPaperPart(){switch(this.size){case e.XL:return t.PAPER_XL;case e.XS:return t.PAPER_XS;case e.SM:return t.PAPER_SM;case e.MD:return t.PAPER_MD;case e.LG:return t.PAPER_LG;case e.CHAT:return t.PAPER_CHAT;default:return t.PAPER_XL}}getContentPart(){switch(this.size){case e.XL:return this.removeBorder?t.CONTENT_XL_NO_BORDER:t.CONTENT_XL;case e.XS:return t.CONTENT_XS;case e.SM:return t.CONTENT_SM;case e.MD:return t.CONTENT_MD;case e.LG:return t.CONTENT_LG;case e.CHAT:return t.CONTENT_CHAT;default:return t.CONTENT_XL}}getPaginationPart(){switch(this.size){case e.XS:return t.PAGINATION_XS;case e.SM:return t.PAGINATION_SM;case e.MD:return t.PAGINATION_MD;case e.LG:return t.PAGINATION_LG;case e.XL:default:return t.PAGINATION_XL}}getActionPart(){return this.removeBorder?t.ACTION_NO_BORDER:this.size===e.CHAT?t.CHAT_ACTION:t.ACTION}render(){const o=this.size===e.CHAT;return this.open?p`
          ...
          <div tabindex="-1" role="presentation" part=${this.getContainerPart()}>
            ...
            >
              <div part="${this.overrideTitle?v:t.TITLE}">
                ${this.overrideTitle?p`<slot name="${b.TITLE}"></slot>`:p`
                    <div part=${C()?t.TITLE_ROOT:t.TITLE_ROOT_RTL}>
                      ...
                      <div part=${t.ICON_ROOT}>
                        <${y("icon-close")}
                          ...
                          size="20"
                          @click=${E.debounce(this.handleClose,300)}
              ...
              <div part=${this.getPaginationPart()}>
                <slot name="${b.PAGINATION}"></slot>
              </div>
              <div part=${this.getActionPart()}>
                <slot name="${b.FOOTER}"></slot>
              </div>
            </div>
          </div>
        </div>
      `:v}};r.FOCUSABLE_SELECTOR=`${S}, ${k}, ${w}, button, input, [tabindex]:not([tabindex="-1"])`;r.MAX_FOCUS_DEPTH=10;u([g({type:Boolean,reflect:!0})],r.prototype,"open",2);u([g({type:String})],r.prototype,"size",2);u([g({type:String})],r.prototype,"dialogTitle",2);u([g({type:Boolean})],r.prototype,"overrideTitle",2);u([g({type:Boolean})],r.prototype,"removeBorder",2);u([g({type:Boolean,reflect:!0})],r.prototype,"disableBackdropClick",2);r=u([I()],r);customElements.get(T)?M("Component (%s) is currently registered and not possible to registrate again.",T):customElements.define(T,r);const z={title:"Feedback/Enchanted Dialog",component:"enchanted-dialog",tags:["a11y-addon"],decorators:[i=>p`
    <div 
    style="
    display: flex; 
  ...
  name: 'Default'
}`,...(x=(_=m.parameters)==null?void 0:_.docs)==null?void 0:x.source}}};var D,N,O;h.parameters={...h.parameters,docs:{...(D=h.parameters)==null?void 0:D.docs,source:{originalSource:`{
  render: () => {
    return html\`
      <div style="display: flex; flex-direction: column; gap: 40px; padding: 20px;">
        <div>
...
}`,...(O=(N=h.parameters)==null?void 0:N.docs)==null?void 0:O.source}}};const P=["EnchantedDialog","AllStates"],J=Object.freeze(Object.defineProperty({__proto__:null,AllStates:h,EnchantedDialog:m,__namedExportsOrder:P,default:z},Symbol.toStringTag,{value:"Module"}));export{J as E,m as a};
