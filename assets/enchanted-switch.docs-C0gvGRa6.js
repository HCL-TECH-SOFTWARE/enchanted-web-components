import{j as e,M as a,T as d,C as l,a as h}from"./blocks-D7FCWugj.js";import{useMDXComponents as c}from"./index-DYDNvvCy.js";import{E as p,D as r}from"./enchanted-switch.stories-BbNEEXmV.js";import{v as n}from"./cssClassEnums-CY7zIYSt.js";import"./preload-helper-C1FmrZbK.js";import"./commonjsHelpers-Cpj98o6Y.js";import"./iframe-B4blCNHZ.js";import"./tags-BB5KXmdF.js";import"./lodash-CdDiHlzQ.js";import"./keyboardEventKeys-BnoN8uA3.js";const S=new Map([[n.SWITCH_LABEL,"Styles label wrapper around the switch control."],[n.SWITCH_LABEL_DISABLED,"Styles disabled label."],[n.SWITCH_INPUT,"Styles checkbox input element."],[n.SWITCH_SLIDER,"Styles switch visual track."],[n.SWITCH_SLIDER_CHECKED,"Styles checked switch track."],[n.SWITCH_SLIDER_DISABLED,"Styles disabled switch track."],[n.SWITCH_SLIDER_CHECKED_DISABLED,"Styles checked and disabled switch track."]]),m=Object.values(n).map(s=>({name:s,description:S.get(s)??""}));function o(s){const t={code:"code",h2:"h2",p:"p",...c(),...s.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(a,{of:p}),`
