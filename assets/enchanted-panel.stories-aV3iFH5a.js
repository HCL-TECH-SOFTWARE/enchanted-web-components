import{x as r}from"./iframe-BY3ui3w0.js";import{n as d,t as E,E as C}from"./enchanted-ac-base-element-CBHL5x_U.js";import"./enchanted-button-DEmrPq5W.js";import{P as n,o,g as N,i as _}from"./cssClassEnums-D4dgqifY.js";import"./index-CvmBkJio.js";import"./preload-helper-C1FmrZbK.js";import"./state-B3qr-gd1.js";import"./localization-rBpmtxQQ.js";import"./index-F6NVQYd9.js";var $=Object.defineProperty,y=Object.getOwnPropertyDescriptor,a=(i,s,v,p)=>{for(var e=p>1?void 0:p?y(s,v):s,h=i.length-1,u;h>=0;h--)(u=i[h])&&(e=(p?u(s,v,e):u(e))||e);return p&&e&&$(s,v,e),e};let t=class extends C{constructor(){super(...arguments),this.open=!1,this.position=n.PANEL_LEFT,this.headerTitle="",this.ariaLabel="",this.focusPanel=!1}show(){this.open=!0}hide(){this.open=!1}_handleCloseClick(){this.hide(),this.dispatchEvent(new CustomEvent("enchantedPanelClose"))}render(){return r`
      <div
    ...
    `};var m,P,f;c.parameters={...c.parameters,docs:{...(m=c.parameters)==null?void 0:m.docs,source:{originalSource:"{}",...(f=(P=c.parameters)==null?void 0:P.docs)==null?void 0:f.source}}};var T,g,b,A,L;l.parameters={...l.parameters,docs:{...(T=l.parameters)==null?void 0:T.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    }
...
}`,...(b=(g=l.parameters)==null?void 0:g.docs)==null?void 0:b.source},description:{story:`Comprehensive showcase of all panel states and configurations.
Demonstrates different positions, open/closed states, with/without title, and various content scenarios.`,...(L=(A=l.parameters)==null?void 0:A.docs)==null?void 0:L.description}}};const B=["Default","AllStates"];export{l as AllStates,c as Default,B as __namedExportsOrder,H as default};
