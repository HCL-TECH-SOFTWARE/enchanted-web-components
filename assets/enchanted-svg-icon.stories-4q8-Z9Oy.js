import{x as c}from"./iframe-8woUqRZQ.js";import"./enchanted-svg-icon-BVn895_u.js";import"./preload-helper-C1FmrZbK.js";import"./enchanted-ac-base-element-B2r6Mb3d.js";const n=c`
   <svg
     width="16"
     height="16"
     viewBox="0 0 16 16"
 ...
 `,x={title:"Icon/enchanted-svg-icon",component:"enchanted-svg-icon",tags:["autodocs"],parameters:{docs:{description:{component:"The SVG Icon component renders SVG templates with customizable color and size properties. It supports parent color inheritance via useCurrentColor for seamless integration with text and UI elements. Use this component for consistent icon rendering across your application with flexible styling options."}}},argTypes:{icon:{control:{type:"object"},description:"SVG icon template (TemplateResult) to be rendered. Pass a Lit template containing the SVG markup. Required for the icon to display."},color:{control:{type:"color"},description:"Custom color for the icon. Overrides default styling. Ignored when useCurrentColor is true. Accepts any valid CSS color value (hex, rgb, named colors).",table:{category:"Styling",type:{summary:"string"},defaultValue:{summary:""}}},size:{control:{type:"text"},description:'Icon size applied to both width and height. Accepts CSS size values (px, em, rem, %). Example: "24px", "2rem". Ensures consistent aspect ratio.',table:{category:"Layout",type:{summary:"string"},defaultValue:{summary:"16px"}}},useCurrentColor:{control:{type:"boolean"},description:"When true, icon inherits color from parent element. Useful for matching icon color with surrounding text or UI components. Overrides color property.",table:{category:"Styling",type:{summary:"boolean"},defaultValue:{summary:"false"}}}},args:{icon:n,color:"",size:"16px",useCurrentColor:!1}},i={render:s=>c`
      ...
      ></enchanted-svg-icon>
    `},e={parameters:{controls:{disable:!0}},render:()=>c`
      <style>
        .icon-container {
          display: flex;
    ...
    `};var o,a,t;i.parameters={...i.parameters,docs:{...(o=i.parameters)==null?void 0:o.docs,source:{originalSource:`{
  render: args => {
    return html\`
      <enchanted-svg-icon
        .icon=\${args.icon}
...
}`,...(t=(a=i.parameters)==null?void 0:a.docs)==null?void 0:t.source}}};var l,r,d,p,v;e.parameters={...e.parameters,docs:{...(l=e.parameters)==null?void 0:l.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    }
...
Demonstrates default rendering, custom colors, various sizes, and parent color inheritance.`,...(v=(p=e.parameters)==null?void 0:p.docs)==null?void 0:v.description}}};const C=["Default","AllStates"];export{e as AllStates,i as Default,C as __namedExportsOrder,x as default};
