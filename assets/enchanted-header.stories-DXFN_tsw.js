import{x as t,E as $}from"./iframe-8woUqRZQ.js";import{n as o,t as D,l as _,E as x}from"./enchanted-ac-base-element-B2r6Mb3d.js";import"./enchanted-textfield-B3LAaivC.js";import"./enchanted-button-DuogflDy.js";import"./enchanted-badge-DqdTHYsi.js";import{H as e,p as a,k as H,q as S}from"./cssClassEnums-WDBe4U61.js";import"./index-CxxYtbvt.js";import{t as T}from"./index-CuTRIAwF.js";import{c as N,B as O}from"./index-CrPUyF-a.js";import"./index-DV5_aqA1.js";import"./preload-helper-C1FmrZbK.js";import"./state-CWv-Gofn.js";import"./lodash-2IddpDH8.js";import"./localization-D1j1HXL7.js";import"./enchanted-select-Ge91KUgI.js";import"./keyboardEventKeys-BnoN8uA3.js";var g={elem:"svg",attrs:{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 32 32",fill:"currentColor",width:32,height:32},content:[{elem:"path",attrs:{d:"M18,28H14a2,2,0,0,1-2-2V18.41L4.59,11A2,2,0,0,1,4,9.59V6A2,2,0,0,1,6,4H26a2,2,0,0,1,2,2V9.59A2,2,0,0,1,27.41,11L20,18.41V26A2,2,0,0,1,18,28ZM6,6V9.59l8,8V26h4V17.59l8-8V6Z"}}],name:"filter",size:32};const m="icon-filter";class w extends O{render(){return t`${T({...g,attrs:{...g.attrs,preserveAspectRatio:"xMidYMid"}})}`}}N&&!customElements.get(m)&&customElements.define(m,w);var I=Object.defineProperty,C=Object.getOwnPropertyDescriptor,s=(n,i,p,l)=>{for(var r=l>1?void 0:l?C(i,p):i,v=n.length-1,u;v>=0;v--)(u=n[v])&&(r=(l?u(i,p,r):u(r))||r);return l&&r&&I(i,p,r),r};let d=class extends x{constructor(){super(...arguments),this.headerTitle="",this.showBackIcon=!1,this.isSideNavOpen=!1,this.disabled=!1,this.variant=void 0}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback()}renderTitle(i){switch(i){case e.HEADER_AUTHORING:return t`${this.getMessage("header.authoring.search")}`;case e.HEADER_AUTHORING_MODAL_CLOSE:return t`${this.getMessage("header.authoring.search")}`;case e.HEADER_ENDUSER:return t`${this.getMessage("header.enduser.search.center.title")}`;default:return t`${this.headerTitle}`}}renderEndSection(i){switch(i){case e.HEADER_AUTHORING:return t`
          ...
          <div part=${a.HEADER_SPACING_END}>
            ...
            <enchanted-badge part=${S.BADGE_DOT}/>
...
}`,...(R=(b=c.parameters)==null?void 0:b.docs)==null?void 0:R.source}}};const X=["EnchantedHeader","AllStates"];export{c as AllStates,h as EnchantedHeader,X as __namedExportsOrder,Q as default};
