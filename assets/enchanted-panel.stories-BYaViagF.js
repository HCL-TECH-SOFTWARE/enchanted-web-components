import{c as b,M as h,a as y,f as t,g as A,u as p,n as r,N as n}from"./tags-BB5KXmdF.js";import"./enchanted-button-D6oqnDeG.js";import{a2 as e,P as s,p as N,R as O,d as x}from"./cssClassEnums-CY7zIYSt.js";import"./index-CWwr-8yc.js";var S=Object.defineProperty,c=(i,T,m,G)=>{for(var o=void 0,v=i.length-1,E;v>=0;v--)(E=i[v])&&(o=E(T,m,o)||o);return o&&S(T,m,o),o};const D=b("enchanted-web-components:components:atomic-component:enchanted-panel.ts");class l extends y{constructor(){super(...arguments),this.open=!1,this.position=e.PANEL_LEFT,this.headerTitle="",this.ariaLabel="",this.focusPanel=!1}show(){this.open=!0}hide(){this.open=!1}_handleCloseClick(){this.hide(),this.dispatchEvent(new CustomEvent("enchantedPanelClose"))}render(){return p`
      <div
