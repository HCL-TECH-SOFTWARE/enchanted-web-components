import{W as t,X as e,u as I}from"./tags-GuWqQq8Q.js";import"./enchanted-list-item-BSeQRxWx.js";import"./iframe-DIZdwA76.js";import"./preload-helper-C1FmrZbK.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./cssClassEnums-BAuKGcJP.js";const S={title:"Data Display/Enchanted List",tags:["autodocs","a11y-addon"],argTypes:{role:{control:{type:"text"},description:'ARIA role attribute for the list element. Common values include "listbox", "menu", or empty string for default list semantics. Enhances accessibility by defining the semantic purpose of the list.',table:{category:"Accessibility",type:{summary:"string"},defaultValue:{summary:""}}}},args:{role:""},parameters:{docs:{description:{component:"List container component that renders an unordered list element with support for ARIA roles. Works with enchanted-list-item components to create accessible list structures. Supports custom styling via CSS parts and flexible content via slots."}}},render:r=>I`
      <${t} role="${r.role}">
        <${e}>Item 1</${e}>
        <${e}>Item 2</${e}>
        <${e}>Item 3</${e}>
    ...
    `},T={},i={render:()=>I`
      <div style="display: flex; gap: 32px; flex-wrap: wrap; align-items: flex-start;">
        ...
        <div>
          ...
          <${t} role="listbox" aria-labelledby="listbox-label">
        ...
        <div>
          ...
          <${t} role="menu" aria-labelledby="menu-label">
...
}`,...(o=(l=i.parameters)==null?void 0:l.docs)==null?void 0:o.source}}};const L=["Default","AllStates"];export{i as AllStates,T as Default,L as __namedExportsOrder,S as default};
