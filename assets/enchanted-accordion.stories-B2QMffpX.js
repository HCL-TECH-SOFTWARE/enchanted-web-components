import{c as g,a2 as h,a as f,L as R,u as n,g as T,n as d,a3 as e,a4 as b}from"./tags-CoVdckeD.js";import{x as w,E as C}from"./iframe-q8uLr7wl.js";import{r as I}from"./state-HmA1gIuo.js";import{l as A}from"./lodash-CdDiHlzQ.js";import{g as S}from"./localization-BpntbVwP.js";import{A as t}from"./cssClassEnums-B0FxBdGx.js";import{t as k}from"./index-CuTRIAwF.js";import{c as H,I as G,B as L}from"./tags-Dsu22f7O.js";import{K as N}from"./keyboardEventKeys-BnoN8uA3.js";var $={elem:"svg",attrs:{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 32 32",fill:"currentColor",width:32,height:32},content:[{elem:"path",attrs:{d:"M16 22L6 12 7.4 10.6 16 19.2 24.6 10.6 26 12z"}}],name:"chevron--down",size:32};const m=`${G}icon-chevron-down`;class M extends L{render(){return w`${k({...$,attrs:{...$.attrs,preserveAspectRatio:"xMidYMid"}})}`}}H&&!customElements.get(m)&&customElements.define(m,M);var W=Object.defineProperty,a=(o,s,y,z)=>{for(var r=void 0,p=o.length-1,u;p>=0;p--)(u=o[p])&&(r=u(s,y,r)||r);return r&&W(s,y,r),r};const B=g("enchanted-web-components:components:atomic-component:enchanted-accordion.ts");let i=class extends f{constructor(){super(...arguments),this.showCheckbox=!1,this.disabled=!1,this.showSecondaryText=!1,this.type="outlined",this.open=!1,this.label="",this.secondaryText="",this.isLTR=S()===R.LTR}toggleAccordion(){this.disabled||(this.open=!this.open)}handleKeyToggle(s){(s.key===N.ENTER||s.key===N.SPACE)&&(s.preventDefault(),this.toggleAccordion())}handleArrowClick(s){s.stopPropagation(),this.toggleAccordion()}render(){return n`
      <div
      ...
      >
        ...
        >
          ...
          <div
            ...
            @click=${A.debounce(this.toggleAccordion,300)}
          >
            ${this.label?n`<div
        ...
        <span
          ...
          @click=${A.debounce(this.handleArrowClick,300)}
          @keydown=${this.handleKeyToggle}
        >
          <${T("icon-chevron-down")}
...
}`,...(v=(D=l.parameters)==null?void 0:D.docs)==null?void 0:v.source}}};const P=["EnchantedAccordion","AllStates"],ee=Object.freeze(Object.defineProperty({__proto__:null,AllStates:l,EnchantedAccordion:c,__namedExportsOrder:P,default:V},Symbol.toStringTag,{value:"Module"}));export{ee as E,c as a};
