import{x as r,E as h}from"./iframe-Dsd1MpWQ.js";import{n as p,t as N,l as P,D as L,v as V}from"./dx-ac-base-element-C9dhstFR.js";import{r as m}from"./state-DQlunuPl.js";import{l as F}from"./lodash-BXdGFY-L.js";import"./index-hIW8WEXr.js";import"./dx-button-gwJQrlvi.js";import{o as l,j as A,C as _,i as R,L as k}from"./cssClassEnums-v1h5zF5X.js";import{I as W}from"./exportParts-CtUt9Lva.js";import{K as a}from"./keyboardEventKeys-BnoN8uA3.js";import"./index-DzNqIDb7.js";import"./index-CZlevowp.js";import"./index-DBmzuMS8.js";import{c as U,B as M,t as H}from"./index-BPZZDKKN.js";import"./preload-helper-C1FmrZbK.js";import"./dx-avatar-CcPSZodn.js";import"./localization-DmqTGOFp.js";var y={elem:"svg",attrs:{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 32 32",fill:"currentColor",width:32,height:32},content:[{elem:"path",attrs:{d:"M16,2C8.2,2,2,8.2,2,16s6.2,14,14,14s14-6.2,14-14S23.8,2,16,2z M21.4,23L16,17.6L10.6,23L9,21.4l5.4-5.4L9,10.6L10.6,9	l5.4,5.4L21.4,9l1.6,1.6L17.6,16l5.4,5.4L21.4,23z"}},{elem:"path",attrs:{d:"M14.4 16L9 10.6 10.6 9 16 14.4 21.4 9 23 10.6 17.6 16 23 21.4 21.4 23 16 17.6 10.6 23 9 21.4 14.4 16","data-icon-path":"inner-path",opacity:"0"}}],name:"close--filled",size:32};const $="icon-close-filled";class q extends M{render(){return r`${H({...y,attrs:{...y.attrs,preserveAspectRatio:"xMidYMid"}})}`}}U&&!customElements.get($)&&customElements.define($,q);var B=Object.defineProperty,z=Object.getOwnPropertyDescriptor,o=(e,t,i,c)=>{for(var d=c>1?void 0:c?z(t,i):t,f=e.length-1,b;f>=0;f--)(b=e[f])&&(d=(c?b(t,i,d):b(d))||d);return c&&d&&B(t,i,d),d};let n=class extends L{constructor(){super(...arguments),this.toggleDropDown=!1,this.currentFocusedItem=void 0,this.inputValue="",this.onInputHover=!1,this.isInputFocused=!1,this.isClearAllIconFocused=!1,this.disabled=!1,this.showHelperText=!1,this.helperText="",this.name="multiple-select",this.selectedValues=[],this.options=[],this.field="",this.showRemoveLabel=!1,this.emptyOptions=!1,this.clearIcon=!0,this.placeholder=this.getMessage("authoring.multi.select.placeholder"),this.label=this.getMessage("authoring.multi.select.label"),this.handleOutsideClick=e=>{const t=e.target;!this.contains(t)&&this.toggleDropDown&&(this.toggleDropDown=!1,this.inputValue="",this.requestUpdate())}}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.handleDropdownNav),document.addEventListener("click",this.handleOutsideClick)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("keydown",this.handleDropdownNav),document.removeEventListener("click",this.handleOutsideClick)}handleListItemClick(e){var b;e.stopPropagation();const t=e.currentTarget,i=(b=t.textContent)==null?void 0:b.trim(),c=t.getAttribute("id")||i;if(!c||!i)return;if(this.selectedValues.find(u=>u.id===c))this.selectedValues=this.selectedValues.filter(u=>u.id!==c);else{const u=this.options.find(C=>C.id===c);u&&(this.selectedValues=[...this.selectedValues,{id:u.id,name:u.name,value:u.value}])}this.inputValue="",this.toggleDropDown=!0;const f=this.renderRoot.querySelector(`#${l.INPUT_FIELD}`);f&&f.focus(),this.currentFocusedItem=t,this.dispatchChangeEvent(),this.requestUpdate()}handleChipRemove(e,t){e.stopPropagation(),this.selectedValues=this.selectedValues.filter(c=>c.id!==t),this.dispatchChangeEvent(),this.requestUpdate();const i=this.renderRoot.querySelector(`#${l.INPUT_FIELD}`);i&&i.focus()}handleClearAll(){const e=this.toggleDropDown;this.selectedValues=[],this.inputValue="",this.dispatchChangeEvent(),this.toggleDropDown=e,this.requestUpdate();const t=this.renderRoot.querySelector(`#${l.INPUT_FIELD}`);t&&t.focus()}handleInput(e){e.stopPropagation();const t=e.target;this.inputValue=t.value,this.toggleDropDown||(this.toggleDropDown=!0),this.dispatchEvent(new CustomEvent("input",{detail:{value:this.inputValue,type:this.field},bubbles:!0,composed:!0}))}getDivInputParts(){let e=l.INPUT_CONTAINER;return this.disabled&&(e=`${e} ${l.INPUT_CONTAINER_DISABLED}`),e}handleInputKeyDown(e){e.stopPropagation(),e.key===a.ENTER||e.key===a.SPACE?(e.preventDefault(),this.disabled||(this.emptyOptions&&this.inputValue&&e.key===a.ENTER?(this.selectedValues=[...this.selectedValues,{id:this.inputValue,name:this.inputValue,value:this.inputValue}],this.inputValue="",this.dispatchChangeEvent(),this.requestUpdate()):(this.toggleDropDown=!this.toggleDropDown,this.toggleDropDown&&(this.listItems=Array.from(this.renderRoot.querySelectorAll("dx-list-item")),this.listItems.length>0&&(this.currentFocusedItem=this.listItems[0],this.currentFocusedItem.focus())),this.requestUpdate()))):(e.key===a.BACKSPACE||e.key===a.DELETE)&&!this.inputValue&&this.selectedValues.length>0?(this.selectedValues=this.selectedValues.slice(0,-1),this.dispatchChangeEvent(),this.requestUpdate()):e.key===a.ARROW_DOWN&&this.toggleDropDown?(e.preventDefault(),this.listItems=Array.from(this.renderRoot.querySelectorAll("dx-list-item")),this.listItems.length>0&&(this.currentFocusedItem=this.listItems[0],this.currentFocusedItem.focus())):e.key===a.ESCAPE&&this.toggleDropDown&&(e.preventDefault(),this.toggleDropDown=!1)}dispatchChangeEvent(){const e=this.selectedValues.map(t=>({id:t.id,name:t.name||t.id,value:t.value||t.id}));this.dispatchEvent(new CustomEvent("change",{detail:{value:e,type:this.field}})),this.toggleDropDown=!1}async handleButtonClick(e){e.stopPropagation(),!this.disabled&&(this.toggleDropDown=!this.toggleDropDown,await this.updateComplete&&this.toggleDropDown&&(this.listItems=Array.from(this.renderRoot.querySelectorAll("dx-list-item")),this.listItems.length>0&&(this.currentFocusedItem=this.listItems[0],this.currentFocusedItem.focus())))}handleInputContainerClick(e){e.stopPropagation();const t=this.renderRoot.querySelector(`#${l.INPUT_FIELD}`);t&&!this.disabled&&e.target!==this.renderRoot.querySelector(`#${l.CLEAR}`)&&(t.focus(),this.toggleDropDown=!this.toggleDropDown,this.requestUpdate())}async handleDropdownNav(e){if(e.key===a.ESCAPE&&this.toggleDropDown){e.preventDefault(),this.toggleDropDown=!1,this.requestUpdate();const t=this.renderRoot.querySelector(`#${l.INPUT_FIELD}`);t&&t.focus();return}if(!(!this.toggleDropDown||!this.listItems))switch(e.key){case a.ARROW_DOWN:{e.preventDefault(),this.listItems=Array.from(this.renderRoot.querySelectorAll("dx-list-item"));const t=this.currentFocusedItem?this.listItems.indexOf(this.currentFocusedItem):-1;t<this.listItems.length-1&&(this.currentFocusedItem=this.listItems[t+1],this.currentFocusedItem.focus(),this.toggleDropDown=!0);break}case a.ARROW_UP:{e.preventDefault();const t=this.currentFocusedItem?this.listItems.indexOf(this.currentFocusedItem):-1;t>0&&(this.currentFocusedItem=this.listItems[t-1],this.currentFocusedItem.focus(),this.toggleDropDown=!0);break}case a.ENTER:{e.preventDefault(),await this.updateComplete&&(this.listItems=Array.from(this.renderRoot.querySelectorAll("dx-list-item"))),this.currentFocusedItem&&this.currentFocusedItem.click();break}}}handleRemoveLabelClick(e){e.stopPropagation(),this.dispatchEvent(new CustomEvent("remove",{bubbles:!0,detail:{name:this.name,type:this.field}}))}getOptionName(e){return typeof e=="string"?e:e.name||e.id}handleOnMouseOver(e){e.stopPropagation(),e.preventDefault(),this.onInputHover=!0,this.requestUpdate()}handleOnMouseOut(e){e.stopPropagation(),this.onInputHover=!1,this.requestUpdate()}getPartClearAllIcon(){return(this.onInputHover||this.isInputFocused||this.isClearAllIconFocused)&&this.selectedValues.length>0?l.CLEAR_ALL_ICON:l.CLEAR_ALL_ICON_HIDDEN}getSelectedOption(e){const t=typeof e=="string"?e:e.id||e.name;return r`
    <dx-list-item
      @pointerdown=${this.handleListItemClick}
      @keydown=${i=>{(i.key===a.ENTER||i.key===a.SPACE)&&(i.preventDefault(),this.handleListItemClick(i))}}
    ...
    >
      <div part="${l.LIST_ITEM_CONTENT}">
        ...
        >
          ${this.selectedValues.some(i=>i.id===t)?r`<icon-checkmark size="16" alt="Selected" color="rgba(0, 0, 0, 0.60)"></icon-checkmark>`:h}
        </div>
        ...
        >
          ${this.clearIcon?r`
                <span
                  ...
                  @keydown=${c=>{(c.key===a.ENTER||c.key===a.SPACE)&&(c.preventDefault(),this.handleChipRemove(c,t))}}
    ...
    > <div part="${l.MULTIPLE_SELECT_DIV_LABEL_AND_REMOVE}">
        ...
        ${this.showRemoveLabel?r`
          <label data-testid="multiple-select-remove-label"
            ...
            @keydown=${t=>{this.disabled||(t.key===a.ENTER||t.key===a.SPACE)&&(t.preventDefault(),this.handleRemoveLabelClick(t))}}
          >
      ...
      <div
        ...
        @click=${t=>{document.querySelectorAll("dx-multiple-select-chip").forEach(i=>{i!==this&&i.toggleDropDown&&(i.toggleDropDown=!1)}),this.handleInputContainerClick(t)}}
        @keydown=${t=>{if((t.key===a.ENTER||t.key===a.SPACE)&&!this.disabled){t.preventDefault(),this.toggleDropDown=!this.toggleDropDown,this.toggleDropDown&&(this.listItems=Array.from(this.renderRoot.querySelectorAll("dx-list-item")),this.listItems.length>0&&(this.currentFocusedItem=this.listItems[0],this.currentFocusedItem.focus()));const i=this.renderRoot.querySelector(`#${l.INPUT_FIELD}`);i&&i.focus(),this.requestUpdate()}}}
      >
        <div
        ...
        <div part="${l.CLEAR_AND_ICON_CONTAINER}">
          ${this.selectedValues.length>0?r`
              <dx-icon-button
                ...
                @keydown=${t=>{(t.key===a.ENTER||t.key===a.SPACE)&&(t.preventDefault(),t.stopPropagation(),this.handleClearAll())}}
            ...
            `:h}
          <dx-button
            @click=${t=>{document.querySelectorAll("dx-multiple-select-chip").forEach(i=>{i!==this&&i.toggleDropDown&&(i.toggleDropDown=!1)}),this.handleButtonClick(t)}}
          
            @keydown=${t=>{if((t.key===a.ENTER||t.key===a.SPACE)&&(t.preventDefault(),this.handleButtonClick(t)),t.key===a.TAB&&this.toggleDropDown){this.toggleDropDown=!1;return}}}
  ...
  `}};o([m()],n.prototype,"toggleDropDown",2);o([m()],n.prototype,"listItems",2);o([m()],n.prototype,"currentFocusedItem",2);o([m()],n.prototype,"inputValue",2);o([m()],n.prototype,"onInputHover",2);o([m()],n.prototype,"isInputFocused",2);o([m()],n.prototype,"isClearAllIconFocused",2);o([p({type:Boolean})],n.prototype,"disabled",2);o([p({type:Boolean})],n.prototype,"showHelperText",2);o([p({type:String})],n.prototype,"helperText",2);o([p({type:String})],n.prototype,"name",2);o([p({type:Array})],n.prototype,"selectedValues",2);o([p({type:Array})],n.prototype,"options",2);o([p({type:String})],n.prototype,"field",2);o([p({type:Boolean})],n.prototype,"showRemoveLabel",2);o([p({type:Boolean})],n.prototype,"emptyOptions",2);o([p({type:Boolean})],n.prototype,"clearIcon",2);o([p({type:String})],n.prototype,"customWidth",2);o([p({type:String})],n.prototype,"placeholder",2);o([p({type:String})],n.prototype,"label",2);n=o([N("dx-multiple-select-chip"),P()],n);const s=[{id:"apple",name:"Apple",value:"apple"},{id:"banana",name:"Banana",value:"banana"},{id:"cherry",name:"Cherry",value:"cherry"},{id:"date",name:"Date",value:"date"}],ce={title:"Input/dx-multiple-select-chip",component:"dx-multiple-select-chip",tags:["autodocs"],parameters:{docs:{description:{component:"The Multiple Select Chip component allows users to select multiple options from a dropdown menu, displaying selections as removable chips. Features include search/filter, clear all functionality, helper text, error states, and custom styling. Use this component for multi-selection scenarios like tags, categories, or filtering where visual representation of selections is important."}}},argTypes:{options:{control:{type:"object"},description:"Array of available options for selection. Each option should have id, name, and value properties. Options populate the dropdown menu.",table:{category:"Content",type:{summary:"OptionData[]"},defaultValue:{summary:"[]"}}},selectedValues:{control:{type:"object"},description:"Array of currently selected options displayed as chips. Each selection appears as a removable chip above the input field.",table:{category:"State",type:{summary:"OptionData[]"},defaultValue:{summary:"[]"}}},label:{control:{type:"text"},description:"Label text displayed above the input field. Provides context for what users are selecting. Uses localized default if not specified.",table:{category:"Content",type:{summary:"string"},defaultValue:{summary:"localized"}}},placeholder:{control:{type:"text"},description:"Placeholder text shown in the input when empty. Guides users on what to select. Uses localized default if not specified.",table:{category:"Content",type:{summary:"string"},defaultValue:{summary:"localized"}}},disabled:{control:{type:"boolean"},description:"Disables the entire component including input field, chips, and all interactions. Visual styling indicates disabled state.",table:{category:"State",type:{summary:"boolean"},defaultValue:{summary:"false"}}},showHelperText:{control:{type:"boolean"},description:"Shows helper text below the input field. Must be true for helperText to display. Used for instructions or error messages.",table:{category:"Display",type:{summary:"boolean"},defaultValue:{summary:"false"}}},helperText:{control:{type:"text"},description:"Helper text content displayed below input when showHelperText is true. Provides guidance, hints, or validation feedback.",table:{category:"Content",type:{summary:"string"},defaultValue:{summary:""}}},showRemoveLabel:{control:{type:"boolean"},description:"Shows accessible remove label on chip close buttons. Improves accessibility by providing text description for screen readers.",table:{category:"Accessibility",type:{summary:"boolean"},defaultValue:{summary:"false"}}},emptyOptions:{control:{type:"boolean"},description:"Indicates empty options state. When true, displays appropriate empty state messaging instead of the dropdown list.",table:{category:"State",type:{summary:"boolean"},defaultValue:{summary:"false"}}},clearIcon:{control:{type:"boolean"},description:"Shows clear all icon button when selections exist. Allows users to quickly remove all selected chips with one click.",table:{category:"Display",type:{summary:"boolean"},defaultValue:{summary:"true"}}},customWidth:{control:{type:"number"},description:"Custom width value for the component. Can be specified in pixels or other CSS units. Overrides default width behavior.",table:{category:"Styling",type:{summary:"number"},defaultValue:{summary:"240"}}},name:{control:{type:"text"},description:'Form field name attribute. Used for form submission and identification. Defaults to "multiple-select" if not specified.',table:{category:"Form",type:{summary:"string"},defaultValue:{summary:"multiple-select"}}},field:{control:{type:"text"},description:"Field type configuration string. Used for specialized field behavior or styling based on usage context.",table:{category:"Form",type:{summary:"string"},defaultValue:{summary:""}}}},args:{options:s,selectedValues:[],label:"Fruits",placeholder:"Select fruits",disabled:!1,showHelperText:!1,helperText:"",showRemoveLabel:!1,emptyOptions:!1,clearIcon:!0,customWidth:"",name:"multiple-select",field:""}},x={name:"Default",render:e=>r`
    ...
    `};var g,I,S;x.parameters={...x.parameters,docs:{...(g=x.parameters)==null?void 0:g.docs,source:{originalSource:`{
  name: 'Default',
  render: args => {
    return html\`
      <dx-multiple-select-chip
...
}`,...(S=(I=x.parameters)==null?void 0:I.docs)==null?void 0:S.source}}};var O,T,D,E,w;v.parameters={...v.parameters,docs:{...(O=v.parameters)==null?void 0:O.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    }
...
}`,...(D=(T=v.parameters)==null?void 0:T.docs)==null?void 0:D.source},description:{story:`Comprehensive showcase of all multiple-select-chip states and configurations.
Demonstrates various selection states, validation, helper text, and customization options.`,...(w=(E=v.parameters)==null?void 0:E.docs)==null?void 0:w.description}}};const re=["DxMultipleSelectChipStory","AllStates"];export{v as AllStates,x as DxMultipleSelectChipStory,re as __namedExportsOrder,ce as default};
