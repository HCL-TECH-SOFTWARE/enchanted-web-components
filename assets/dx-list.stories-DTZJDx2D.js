import{x}from"./iframe-Dsd1MpWQ.js";import"./dx-list-item-OcRTzvHV.js";import"./preload-helper-C1FmrZbK.js";import"./dx-ac-base-element-C9dhstFR.js";import"./cssClassEnums-v1h5zF5X.js";const h={title:"Data Display/dx-list",tags:["autodocs"],argTypes:{role:{control:{type:"text"},description:'ARIA role attribute for the list element. Common values include "listbox", "menu", or empty string for default list semantics. Enhances accessibility by defining the semantic purpose of the list.',table:{category:"Accessibility",type:{summary:"string"},defaultValue:{summary:""}}}},args:{role:""},parameters:{docs:{description:{component:"List container component that renders an unordered list element with support for ARIA roles. Works with dx-list-item components to create accessible list structures. Supports custom styling via CSS parts and flexible content via slots."}}},render:r=>x`
      <dx-list role="${r.role}">
      ...
      <div style="display: flex; gap: 32px; flex-wrap: wrap; align-items: flex-start;">
        ...
        <div>
          ...
          <dx-list>
            ...
            <dx-list-item ?isSelected=${!0}>Selected Item 1</dx-list-item>
            <dx-list-item>Regular Item</dx-list-item>
            <dx-list-item ?isSelected=${!0}>Selected Item 2</dx-list-item>
          </dx-list>
        </div>
        ...
        <div>
          ...
          <dx-list>
            <dx-list-item ?isSelected=${!0}>Selected with long text that wraps to multiple lines to show layout</dx-list-item>
            <dx-list-item>Short item</dx-list-item>
            <dx-list-item .key=${"custom-key"}>Item with custom key</dx-list-item>
          </dx-list>
        </div>
      </div>
    `,parameters:{docs:{description:{story:"Comprehensive showcase of all list configurations and list-item states. Demonstrates default lists, ARIA roles (listbox, menu), selected items (isSelected), keyed items, empty lists, scrollable long lists, and mixed content scenarios. Shows 8 different list configurations highlighting various use cases and features."}},controls:{disable:!0}}};var i,s,l;t.parameters={...t.parameters,docs:{...(i=t.parameters)==null?void 0:i.docs,source:{originalSource:"{}",...(l=(s=t.parameters)==null?void 0:s.docs)==null?void 0:l.source}}};var m,d,o;e.parameters={...e.parameters,docs:{...(m=e.parameters)==null?void 0:m.docs,source:{originalSource:`{
  render: () => {
    return html\`
      <div style="display: flex; gap: 32px; flex-wrap: wrap; align-items: flex-start;">
        <div>
...
}`,...(o=(d=e.parameters)==null?void 0:d.docs)==null?void 0:o.source}}};const y=["Default","AllStates"];export{e as AllStates,t as Default,y as __namedExportsOrder,h as default};
