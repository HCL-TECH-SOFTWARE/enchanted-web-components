import{q as t,r as e,u as r}from"./tags-CoVdckeD.js";import"./enchanted-list-item-4M1fmflT.js";const a={title:"Data Display/Enchanted List",tags:["a11y-addon"],argTypes:{role:{control:{type:"text"},description:'ARIA role attribute for the list element. Common values include "listbox", "menu", or empty string for default list semantics. Enhances accessibility by defining the semantic purpose of the list.',table:{category:"Accessibility",type:{summary:"string"},defaultValue:{summary:""}}}},args:{role:""},parameters:{docs:{description:{component:"List container component that renders an unordered list element with support for ARIA roles. Works with enchanted-list-item components to create accessible list structures. Supports custom styling via CSS parts and flexible content via slots."}}},render:I=>r`
      <${t} role="${I.role}">
        <${e}>Item 1</${e}>
        <${e}>Item 2</${e}>
        <${e}>Item 3</${e}>
...
}`,...(o=(l=i.parameters)==null?void 0:l.docs)==null?void 0:o.source}}};const $=["Default","AllStates"],N=Object.freeze(Object.defineProperty({__proto__:null,AllStates:i,Default:T,__namedExportsOrder:$,default:a},Symbol.toStringTag,{value:"Module"}));export{T as D,N as E};
