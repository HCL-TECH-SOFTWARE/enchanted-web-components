import{c as x,$ as v,a as C,L as y,u as l,g as c,n as i,a0 as t,f as e}from"./tags-CoVdckeD.js";import{E as h}from"./iframe-q8uLr7wl.js";import"./index-Bv3ibheM.js";import{g as f}from"./localization-BpntbVwP.js";import{i as a}from"./cssClassEnums-B0FxBdGx.js";import"./enchanted-button-D143v6g8.js";var D=Object.defineProperty,s=(n,d,w,R)=>{for(var p=void 0,u=n.length-1,E;u>=0;u--)(E=n[u])&&(p=E(d,w,p)||p);return p&&D(d,w,p),p};const H=x("enchanted-web-components:components:atomic-component:enchanted-popover.ts");class r extends C{constructor(){super(...arguments),this.open=!1,this.label="Label",this.text="Text",this.showLabel=!1,this.showText=!1,this.showCloseIcon=!1,this.inverse=!1,this.withpadding=!1,this.disablePopover=!1,this._showPopover=()=>{this.disablePopover||(this.open=!0)},this._onFocusIn=()=>{this.disablePopover||(this.open=!0)},this._onFocusOut=()=>{this.disablePopover||(this.open=!1)},this._hidePopover=()=>{this.disablePopover||(this.open=!1)},this._onCloseClick=d=>{d.stopPropagation(),this.open=!1,this.dispatchEvent(new CustomEvent("enchanted-popover-closed",{bubbles:!0,composed:!0,detail:{reason:"click-icon-close"}}))}}get isLTR(){return f()===y.LTR}render(){return l`
      ...
      <div part="${a.POPOVER_ARROW}"></div>`:h}
        <div part=${this.isLTR?a.POPOVER_CONTAINER:a.POPOVER_CONTAINER_RTL}>
          <div part="${a.POPOVER_CONTENT}">
            ${this.showLabel?l`<div part="${a.POPOVER_LABEL}"><slot name="label">${this.label}</slot></div>`:h}
            ${this.showText?l`<div part="${a.POPOVER_TEXT}"><slot name="text">${this.text}</slot></div>`:h}
  ...
  `};var N,O,b;$.parameters={...$.parameters,docs:{...(N=$.parameters)==null?void 0:N.docs,source:{originalSource:`{
  name: 'Default',
  render: args => {
    return html\`
...
}`,...(b=(O=$.parameters)==null?void 0:O.docs)==null?void 0:b.source}}};var _,A,g,m,P;T.parameters={...T.parameters,docs:{...(_=T.parameters)==null?void 0:_.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    }
...
}`,...(g=(A=T.parameters)==null?void 0:A.docs)==null?void 0:g.source},description:{story:`Comprehensive showcase of all popover states and arrow positions.
...
- Label and text visibility combinations`,...(P=(m=T.parameters)==null?void 0:m.docs)==null?void 0:P.description}}};const L=["EnchantedPopoverStory","AllStates"],F=Object.freeze(Object.defineProperty({__proto__:null,AllStates:T,EnchantedPopoverStory:$,__namedExportsOrder:L,default:G},Symbol.toStringTag,{value:"Module"}));export{F as E,$ as a};
