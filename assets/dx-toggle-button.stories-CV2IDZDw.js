import{E as v,x as s}from"./iframe-BabVupQu.js";import{n,t as w,D as _}from"./dx-ac-base-element-CMZo8k64.js";import{i as $}from"./localization-2aoGzCSL.js";import"./dx-badge-fYhlnKRK.js";import"./dx-icon-button-CIJHT7Xz.js";import{w as t,I as U}from"./cssClassEnums-ChRP0d8n.js";import{I as L}from"./exportParts-BXxV9uDV.js";import"./preload-helper-C1FmrZbK.js";import"./dx-button-BmdWVcw5.js";import"./state-ByhEXiYs.js";var V=Object.defineProperty,E=Object.getOwnPropertyDescriptor,i=(o,e,d,r)=>{for(var a=r>1?void 0:r?E(e,d):e,p=o.length-1,f;p>=0;p--)(f=o[p])&&(a=(r?f(e,d,a):f(a))||a);return r&&a&&V(e,d,a),a};let l=class extends _{constructor(){super(...arguments),this.singleButton=!1,this.toggleOn=!1,this.showBadge=!1,this.disabled=!1,this.outlined=!1,this.selectedValue="",this.iconUrls=[],this.values=[],this.singleButtonTitle="",this.singleButtonAria=""}handleClick(o){o.stopPropagation();const e=o.currentTarget;if(e.value!==this.selectedValue){const d=new CustomEvent("click",{detail:{value:e.value}});this.dispatchEvent(d)}}partAttributeDecider(o){let e=o;switch(o){case t.TOGGLE_BUTTON_DIV:return this.outlined&&(e=t.TOGGLE_BUTTON_DIV_OUTLINED),e;case t.FIRST_BUTTON:return this.selectedValue===this.values[0]?e=t.TOGGLE_BUTTON_SELECTED:e=t.TOGGLE_BUTTON,e;case t.SECOND_BUTTON:return this.selectedValue===this.values[1]?e=t.TOGGLE_BUTTON_SELECTED:e=t.TOGGLE_BUTTON,e;case t.TOGGLE_BUTTON_ICON:return e;default:return e}}getButtonAttribute(){return this.toggleOn?t.TOGGLE_ON_SINGLE_BUTTON:t.TOGGLE_OFF_SINGLE_BUTTON}render(){return s`
      ...
      ${this.singleButton===!0?s`
        ${this.showBadge===!0?s`
          <dx-badge 
            ...
            part='${$()?t.TOGGLE_BUTTON_BADGE:`${t.TOGGLE_BUTTON_BADGE} ${t.TOGGLE_BUTTON_BADGE_RTL}`}'
          ></dx-badge>`:""}
        <dx-icon-button
...
}`,...(C=(x=g.parameters)==null?void 0:x.docs)==null?void 0:C.source}}};const R=["Default","AllStates"];export{g as AllStates,u as Default,R as __namedExportsOrder,Z as default};
