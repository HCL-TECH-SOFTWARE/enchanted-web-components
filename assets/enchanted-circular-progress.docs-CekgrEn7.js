import{j as e,M as c,T as d,C as h,a as l}from"./blocks-D7FCWugj.js";import{useMDXComponents as a}from"./index-DYDNvvCy.js";import{E as p,D as i}from"./enchanted-circular-progress.stories-BEbiKXxH.js";import{f as s}from"./cssClassEnums-CY7zIYSt.js";import"./preload-helper-C1FmrZbK.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./iframe-B4blCNHZ.js";import"./tags-BB5KXmdF.js";import"./enchanted-circular-progress-BX6M2mBA.js";const m=new Map([[s.ROOT,"Outer wrapper around the spinner. "],[s.SVG,"SVG element that renders the progress ring."],[s.TRACK,"Track circle behind the progress ring."],[s.CIRCLE,"Animated progress circle."],[s.CIRCLE_DISABLE_SHRINK,"Progress circle without shrink."],[s.LABEL,"Label shown under the spinner."],[s.SPINNER,"Spinner container around the SVG."]]),x=Object.values(s).map(r=>({name:r,description:m.get(r)??""}));function o(r){const n={code:"code",h2:"h2",p:"p",...a(),...r.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(c,{of:p}),`
