import{c as x,a4 as v,E as C,L as y,u as l,g as c,n as i,a5 as t,s as e}from"./tags-GuWqQq8Q.js";import{E as d}from"./iframe-DIZdwA76.js";import"./index-CTiHq96Y.js";import{g as f}from"./localization-CViIwzVj.js";import{t as a}from"./cssClassEnums-BAuKGcJP.js";import"./enchanted-button-BAnGK4C4.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./preload-helper-C1FmrZbK.js";import"./index-CuTRIAwF.js";import"./tags-OypiFpf3.js";import"./state-CtyNSLbf.js";import"./query-BApjzB0v.js";import"./keyboardEventKeys-BnoN8uA3.js";var D=Object.defineProperty,s=(n,$,w,G)=>{for(var p=void 0,u=n.length-1,E;u>=0;u--)(E=n[u])&&(p=E($,w,p)||p);return p&&D($,w,p),p};const H=x("enchanted-web-components:components:atomic-component:enchanted-popover.ts");class r extends C{constructor(){super(...arguments),this.open=!1,this.label="Label",this.text="Text",this.showLabel=!1,this.showText=!1,this.showCloseIcon=!1,this.inverse=!1,this.withpadding=!1,this.disablePopover=!1,this._showPopover=()=>{this.disablePopover||(this.open=!0)},this._onFocusIn=()=>{this.disablePopover||(this.open=!0)},this._onFocusOut=()=>{this.disablePopover||(this.open=!1)},this._hidePopover=()=>{this.disablePopover||(this.open=!1)},this._onCloseClick=$=>{$.stopPropagation(),this.open=!1,this.dispatchEvent(new CustomEvent("enchanted-popover-closed",{bubbles:!0,composed:!0,detail:{reason:"click-icon-close"}}))}}get isLTR(){return f()===y.LTR}render(){return l`
...
}`,...(b=(O=h.parameters)==null?void 0:O.docs)==null?void 0:b.source}}};var _,A,m,g,P;T.parameters={...T.parameters,docs:{...(_=T.parameters)==null?void 0:_.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    }
...
}`,...(m=(A=T.parameters)==null?void 0:A.docs)==null?void 0:m.source},description:{story:`Comprehensive showcase of all popover states and arrow positions.
...
- Label and text visibility combinations`,...(P=(g=T.parameters)==null?void 0:g.docs)==null?void 0:P.description}}};const q=["EnchantedPopoverStory","AllStates"];export{T as AllStates,h as EnchantedPopoverStory,q as __namedExportsOrder,X as default};
