...
export const config = {
  ...
  runner: ['browser', {
    ...
    viteConfig: {
      optimizeDeps: {
        include: ['lit'],
        exclude: ['@hcl-software/enchanted-icons-web-component'],
        entries: [
  ...
  capabilities: [{
    browserName: 'chrome',
    // CI only: skip WDIO's internal ChromeDriver download; locally WDIO manages it automatically
    ...
    'goog:chromeOptions': {
      // CI only: use pre-installed Chrome; locally omit so WDIO resolves it
  ...
  // baseUrl: 'http://localhost:4050/dx/ui/search/',
